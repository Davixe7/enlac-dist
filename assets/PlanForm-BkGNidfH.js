...
import { aj as mergeModels, ak as useModel, r as ref, w as watch, a as computed, o as onMounted, P as createElementBlock, I as openBlock, K as createVNode, _ as createBaseVNode, J as withCtx, ah as QCard, ai as QCardSection, V as QBtn, al as QInput, am as QDialog, N as createTextVNode, L as withDirectives, aS as vShow, Q as QIcon, R as Fragment, S as renderList, H as createBlock, T as toDisplayString, ap as withModifiers, M as createCommentVNode, ag as api, b4 as QToggle, aU as useRouter } from "./index-sn_6H7kT.js";
import { n as notify } from "./notify-ZEsSXxmw.js";
import { _ as _sfc_main$2 } from "./EnlacDate-D7H2NEwy.js";
                  ...
                  default: withCtx(() => [
                    createBaseVNode("tbody", null, [
                      createBaseVNode("tr", null, [
                        _cache[12] || (_cache[12] = createBaseVNode("td", null, "Intensidad", -1)),
                      ...
                      createBaseVNode("tr", null, [
                        _cache[13] || (_cache[13] = createBaseVNode("td", null, "Frencuencia", -1)),
                        createBaseVNode("td", null, [
                          createVNode(QInput, {
                            outlined: "",
                            "stack-label": "",
                      ...
                      createBaseVNode("tr", null, [
                        _cache[14] || (_cache[14] = createBaseVNode("td", null, "Duración", -1)),
                        createBaseVNode("td", null, [
                          createVNode(QInput, {
                            outlined: "",
                            "stack-label": "",
          ...
          createBaseVNode("div", {
            ...
            createVNode(QMarkupTable, {
              ...
              default: withCtx(() => [
                ...
                model.value.length ? (openBlock(), createElementBlock("tbody", _hoisted_8, [
...
const _hoisted_7 = { class: "flex justify-end q-py-lg" };
const _sfc_main = {
  __name: "PlanForm",
  ...
  setup(__props) {
    ...
    async function fetchPlanTypes() {
      try {
        loading.value = true;
        planTypes.value = (await api.get(`plan_types/?plan_category_id=${plan.value.category_id}`)).data.data;
      } catch (error) {
          ...
          createBaseVNode("div", _hoisted_3, [
            createVNode(QSelect, {
              ...
              "onUpdate:modelValue": [
                ...
                _cache[1] || (_cache[1] = ($event) => fetchPlanTypes())
              ],
