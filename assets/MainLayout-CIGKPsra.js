            ...
            default: withCtx(() => [
              createVNode(QList, {
                ...
                default: withCtx(() => [
                  ...
                  !["driver", "chofer"].includes(unref(authStore).data.user.role.name) ? (openBlock(), createBlock(QExpansionItem, {
                    key: 0,
                    dense: "",
                    "expand-separator": "",
                    icon: "settings",
