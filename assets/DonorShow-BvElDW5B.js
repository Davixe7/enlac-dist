import { r as ref, K as onMounted, V as api, q as createBlock, s as openBlock, t as withCtx, v as createVNode, a1 as QCard, X as QCardSection, N as createBaseVNode, x as withDirectives, G as QBtn, Z as withModifiers, Y as QInput, ac as QCardActions, a3 as QDialog, y as createCommentVNode, L as useRoute, D as toDisplayString, Q as QIcon, z as createTextVNode, B as createElementBlock, F as Fragment, C as renderList, E as QSeparator, _ as normalizeClass, af as Dialog } from "./index-CHo5VICr.js";
import { Q as QBadge } from "./QBadge-CKIrwIVy.js";
import { Q as QItem, a as QItemSection } from "./QItem-CDM0OUtz.js";
import { Q as QList } from "./QList-PEd6ETT3.js";
import { Q as QExpansionItem } from "./QExpansionItem-BvU7MpAr.js";
...
import { _ as _sfc_main$4 } from "./DonorFiscalRecordModal-COp1jvyB.js";
...
const _sfc_main$2 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(QDialog, {
        modelValue: isOpen.value,
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => isOpen.value = $event),
        persistent: ""
      }, {
        default: withCtx(() => [
          createVNode(QCard, { style: { "width": "700px", "max-width": "95vw" } }, {
            default: withCtx(() => [
              createVNode(QCardSection, { class: "bg-primary text-white row items-center" }, {
                default: withCtx(() => [
                  _cache[7] || (_cache[7] = createBaseVNode("div", { class: "text-h6" }, "Bitácora de Agradecimientos", -1)),
                  createVNode(QSpace),
                  withDirectives(createVNode(QBtn, {
                    flat: "",
                    round: "",
                      ...
                      createVNode(QMarkupTable, {
                        ...
                        default: withCtx(() => [
                          createBaseVNode("tbody", null, [
                            ...
                            createBaseVNode("tr", null, [
                              _cache[9] || (_cache[9] = createBaseVNode("td", null, "Campaña / Programa *", -1)),
                              createBaseVNode("td", null, [
                                createVNode(QInput, {
                                  outlined: "",
                                  dense: "",
                            ...
                            createBaseVNode("tr", null, [
                              _cache[10] || (_cache[10] = createBaseVNode("td", null, "Tipo de Agradecimiento *", -1)),
                              createBaseVNode("td", null, [
                                createVNode(QInput, {
                                  outlined: "",
                                  dense: "",
                            ...
                            createBaseVNode("tr", null, [
                              _cache[11] || (_cache[11] = createBaseVNode("td", null, "Método de Envío *", -1)),
                              createBaseVNode("td", null, [
                                createVNode(QSelect, {
                                  outlined: "",
                                  dense: "",
                            ...
                            createBaseVNode("tr", null, [
                              _cache[12] || (_cache[12] = createBaseVNode("td", null, "Persona a quien se entrega", -1)),
                              createBaseVNode("td", null, [
                                createVNode(QInput, {
                                  outlined: "",
                                  dense: "",
                            ...
                            createBaseVNode("tr", null, [
                              _cache[13] || (_cache[13] = createBaseVNode("td", null, "Persona que entregó", -1)),
                              createBaseVNode("td", null, [
                                createVNode(QInput, {
                                  outlined: "",
                                  dense: "",
                                  modelValue: form.value.deliverer_name,
                                  "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => form.value.deliverer_name = $event)
                                }, null, 8, ["modelValue"])
                              ])
                            ])
                          ])
...
const _hoisted_34 = { class: "text-grey-6" };
const _hoisted_35 = { class: "text-center" };
const _hoisted_36 = {
  key: 1,
  class: "text-caption text-negative text-bold"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function confirmCancelDonation(donationId, folioNumber) {
      Dialog.create({
        title: "Confirmar cancelación",
        message: `¿Estás seguro de que deseas cancelar el donativo con folio "${folioNumber}"? Esta acción marcará permanentemente el registro como cancelado.`,
        cancel: {
          flat: true,
          label: "Regresar"
        },
        ...
        try {
          await api.put(`/donations/${donationId}/cancel`);
          notify.positive("Donativo cancelado con éxito.");
          await loadDonorData();
        } catch (error) {
          console.error(error);
          notify.negative(error.response?.data?.message || "Ocurrió un error al intentar cancelar.");
        }
      });
    }
                    ...
                    default: withCtx(() => [
                      _cache[41] || (_cache[41] = createBaseVNode("thead", null, [
                        createBaseVNode("tr", { class: "bg-grey-1 text-grey-7" }, [
                          ...
                          createBaseVNode("th", { class: "text-left" }, "Persona que entregó"),
                          createBaseVNode("th", { class: "text-right" }, "Acciones")
                        ])
                      ], -1)),
                      createBaseVNode("tbody", null, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(donor.value.gratitudes, (gratitude) => {
                          return openBlock(), createElementBlock("tr", {
                            ...
                            createBaseVNode("td", null, toDisplayString(gratitude.deliverer_name), 1),
                    ...
                    default: withCtx(() => [
                      _cache[48] || (_cache[48] = createBaseVNode("thead", null, [
                        createBaseVNode("tr", { class: "bg-grey-1 text-grey-7" }, [
                          ...
                          createBaseVNode("th", { class: "text-center" }, "Acciones")
                        ])
                      ], -1)),
                      createBaseVNode("tbody", null, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(donor.value.donations, (donative) => {
                          return openBlock(), createElementBlock("tr", {
                            key: donative.id,
                            class: normalizeClass({ "cancelled-donation-row bg-red-1": donative.is_cancelled })
                          }, [
                            createBaseVNode("td", {
                              class: normalizeClass(["text-weight-medium", donative.is_cancelled ? "text-negative text-strike" : "text-primary"])
                            }, [
                              createTextVNode(toDisplayString(donative.folio_number) + " ", 1),
                              donative.is_cancelled ? (openBlock(), createBlock(QBadge, {
                                key: 0,
                                color: "negative",
                                class: "q-ml-xs text-weight-bold"
                              }, {
                                default: withCtx(() => _cache[45] || (_cache[45] = [
                                  createTextVNode("CANCELADO")
                                ])),
                                _: 1
                              })) : createCommentVNode("", true)
                            ], 2),
                            createBaseVNode("td", {
                              class: normalizeClass({ "text-strike text-grey-6": donative.is_cancelled })
                            }, toDisplayString(formatDate(donative.payment_date)), 3),
                            createBaseVNode("td", null, [
                              createVNode(QBadge, {
                                color: donative.is_cancelled ? "grey-5" : "blue-grey-6",
                                outline: ""
                              }, {
                                default: withCtx(() => [
                            ...
                            createBaseVNode("td", {
                              ...
                              class: normalizeClass(["ellipsis", { "text-strike text-grey-6": donative.is_cancelled }])
                            }, toDisplayString(donative.concept || "N/A"), 3),
                            createBaseVNode("td", {
                              class: normalizeClass({ "text-strike text-grey-6": donative.is_cancelled })
                            }, toDisplayString(donative.payment_method), 3),
                            createBaseVNode("td", null, [
                              createVNode(QBadge, {
                                color: donative.is_cancelled ? "grey-4" : donative.has_tax_receipt ? "positive" : "grey-5"
                              }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(donative.has_tax_receipt ? donative.tax_receipt_number || "Sí" : "No"), 1)
                                ]),
                                _: 2
                              }, 1032, ["color"])
                            ]),
                            createBaseVNode("td", {
                              class: normalizeClass(["text-right text-weight-bold", donative.is_cancelled ? "text-negative text-strike" : ""])
                            }, [
                              createTextVNode(" $ " + toDisplayString(donative.amount) + " ", 1),
                              createBaseVNode("small", _hoisted_34, toDisplayString(donative.currency), 1)
                            ], 2),
                            createBaseVNode("td", _hoisted_35, [
                              !donative.is_cancelled ? (openBlock(), createBlock(QBtn, {
                                key: 0,
                                flat: "",
                                round: "",
                                dense: "",
                                icon: "block",
                                color: "negative",
                                onClick: ($event) => confirmCancelDonation(donative.id, donative.folio_number)
                              }, {
                                default: withCtx(() => [
                                  createVNode(QTooltip, null, {
                                    default: withCtx(() => _cache[46] || (_cache[46] = [
                                      createTextVNode("Cancelar Donativo")
                                    ])),
                                    _: 1
                                  })
                                ]),
                                _: 2
                              }, 1032, ["onClick"])) : (openBlock(), createElementBlock("span", _hoisted_36, "Cancelado"))
                            ])
                          ], 2);
                        }), 128)),
                        !donor.value.donations || donor.value.donations.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_37, _cache[47] || (_cache[47] = [
                          createBaseVNode("td", {
                            colspan: "8",
                  ...
                  createVNode(QMarkupTable, { flat: "" }, {
                    default: withCtx(() => [
                      ...
                      createBaseVNode("tbody", null, [
                        ...
                        !donor.value.status_logs || donor.value.status_logs.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_38, _cache[50] || (_cache[50] = [
                          createBaseVNode("td", {
                            colspan: "2",
                            class: "text-center text-grey-6 q-py-md"
