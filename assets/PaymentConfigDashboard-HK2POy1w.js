...
import { u as useQuasar } from "./use-quasar-DqB1LkvA.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => showDownloadDialog.value = $event)
        }, {
          default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_1$1, [
                      _cache[4] || (_cache[4] = createBaseVNode("div", { class: "page-subtitle q-mb-md" }, "Descargar Carta", -1)),
                      createVNode(QBtn, {
                        flat: "",
                        round: "",
                        dense: "",
                    ...
                    createVNode(QForm, null, {
                      default: withCtx(() => [
                        createVNode(QSelect, {
                          ...
                          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => carta.value.contact_id = $event),
                          "hide-bottom-space": "",
                        ...
                        createVNode(QInput, {
                          ...
                          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => carta.value.periodo = $event),
                          label: "Periodo",
