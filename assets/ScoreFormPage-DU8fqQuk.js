import { y as getCurrentInstance, a7 as inject, a8 as emptyRenderFn, a9 as layoutKey, A as computed, C as hSlot, B as h, v as createComponent, aF as mergeModels, aG as useModel, q as createBlock, a as openBlock, w as withCtx, d as createVNode, Q as QInput, b as createBaseVNode, t as toDisplayString, aH as normalizeProps, aI as guardReactiveProps, O as normalizeClass, j as createTextVNode, r as ref, D as watch, o as onMounted, c as createElementBlock, E as createCommentVNode, L as QRadio, h as QBtn, m as QCard, k as QIcon, H as Fragment, l as api, K as renderList, i as QCheckbox, n as QCardSection } from "./index-CIixvMyj.js";
import { a as QItem, Q as QItemSection, b as QItemLabel } from "./QItem-DBnEobVN.js";
import { Q as QList } from "./QList-Cyz_qr_Z.js";
import { Q as QImg } from "./QImg-D7-rAmf3.js";
...
import { Q as QSelect } from "./QSelect-CUr3bFcr.js";
import { Q as QTable } from "./QTable-BlWVfU6P.js";
import { _ as _sfc_main$2 } from "./EnlacDate-ub136tD-.js";
          ...
          createBaseVNode("div", _hoisted_2, [
                          ...
                          createVNode(QItemSection, { side: "" }, {
                            default: withCtx(() => [
                              createVNode(QCheckbox, {
                                ...
                                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => optionId.value = $event),
                                val: result.id,
            ...
            scores.value && scores.value.length && !dayClosed.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
              isClosable.value ? (openBlock(), createBlock(QBtn, {
                ...
                color: "secondary",
                label: "Cerrar dia",
                onClick: _cache[5] || (_cache[5] = ($event) => storeScores(1)),
              ...
              createVNode(QBtn, {
                ...
                onClick: _cache[6] || (_cache[6] = ($event) => storeScores(0)),
                loading: savingScores.value
                ...
                default: withCtx(() => [
                  createVNode(QCardSection, { class: "bg-positive" }, {
                    default: withCtx(() => [
                      ...
                      _cache[11] || (_cache[11] = createBaseVNode("span", { class: "text-green-1" }, "Dia cerrado, no se admiten actualizaciones.", -1))
                    ]),
                    _: 1
                  })
                ]),
            ...
            optionId.value ? (openBlock(), createBlock(_sfc_main$1, {
              key: 2,
              rows: scores.value,
              "onUpdate:rows": _cache[7] || (_cache[7] = ($event) => scores.value = $event),
            ...
            scores.value && scores.value.length && !dayClosed.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
              isClosable.value ? (openBlock(), createBlock(QBtn, {
                key: 0,
                disable: deferredDate.value || dayClosed.value,
                color: "secondary",
            ...
            emptySearch.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
              createVNode(QIcon, { name: "sym_o_info" }),
              _cache[12] || (_cache[12] = createTextVNode(" No hay resultados coincidentes con la busqueda "))
            ])) : createCommentVNode("", true),
            !optionId.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
              createVNode(QImg, {
                src: "/public/actividades.png",
                width: "200px"
              }),
              _cache[13] || (_cache[13] = createBaseVNode("h6", { class: "q-my-sm" }, "Selecciona un beneficiario o actividad", -1)),
              _cache[14] || (_cache[14] = createBaseVNode("p", null, "para empezar a evaluar", -1))
            ])) : createCommentVNode("", true)
          ])
        ]),
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_13, [
                  ...
                  createBaseVNode("div", null, [
                    _cache[15] || (_cache[15] = createTextVNode(" Estás visualizando una fecha pasada, no se admiten modificaciones. ")),
                    createVNode(QBtn, {
                      unelevated: "",
                      dense: "",
                      label: "Ir a hoy",
                      onClick: _cache[10] || (_cache[10] = ($event) => dateISO.value = (/* @__PURE__ */ new Date()).toISOString().split("T")[0]),
