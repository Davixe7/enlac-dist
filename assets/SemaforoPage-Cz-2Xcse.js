import { r as ref, w as watch, a as computed, K as onMounted, q as createBlock, s as openBlock, t as withCtx, N as createBaseVNode, B as createElementBlock, y as createCommentVNode, _ as normalizeClass, v as createVNode, a2 as QCheckbox, am as QRadio, Y as QInput, F as Fragment, C as renderList, z as createTextVNode, D as toDisplayString, G as QBtn, V as api, a1 as QCard, X as QCardSection, a3 as QDialog } from "./index-CHo5VICr.js";
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const payment = ref({
      ...
      sponsor_id: props.month.sponsor_id || null
    });
    ...
    async function storePayment() {
      ...
      try {
        ...
        if (newPayment && newPayment.id) {
          ...
          printWindow.location.href = `${baseUrl}/payments/${newPayment.id}/receipt`;
        } else {
