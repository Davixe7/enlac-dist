import { aj as mergeModels, ak as useModel, o as onMounted, r as ref, ag as api, a as computed, w as watch, P as createElementBlock, I as openBlock, K as createVNode, _ as createBaseVNode, J as withCtx, N as createTextVNode, T as toDisplayString, V as QBtn, ah as QCard, ai as QCardSection, al as QInput, ao as QCardActions, L as withDirectives, am as QDialog, as as QRadio, aS as vShow, H as createBlock, M as createCommentVNode, aq as QCheckbox, R as Fragment, S as renderList } from "./index-sn_6H7kT.js";
import { Q as QSelect, b as QField } from "./QSelect-2cph_QJY.js";
import { Q as QMarkupTable } from "./QMarkupTable-DyVJAzEn.js";
import { Q as QTd } from "./QTd-BiPpO7ao.js";
import { Q as QTr } from "./QTr-DXsrH3YH.js";
            ...
            createVNode(QTr, { class: "bg-grey-2 text-weight-bold" }, {
              default: withCtx(() => [
                ...
                createVNode(QTd, null, {
                  default: withCtx(() => [
                    createTextVNode(" $ " + toDisplayString(monthlyIncomeSum.value), 1)
                  ]),
                  _: 1
                }),
                createVNode(QTd, null, {
                  default: withCtx(() => [
                    createTextVNode(" $ " + toDisplayString(monthlyContributionSum.value), 1)
                  ]),
                  _: 1
                })
              ]),
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("tbody", null, [
                      ...
                      createBaseVNode("tr", null, [
                        ...
                        createBaseVNode("td", null, "$ " + toDisplayString(totalExpenses.value), 1)
                      ]),
                      createBaseVNode("tr", null, [
                        _cache[93] || (_cache[93] = createBaseVNode("td", null, "Total de ingresos:", -1)),
                        createBaseVNode("td", null, "$ " + toDisplayString(familyData.value.income), 1)
                      ]),
                      createBaseVNode("tr", null, [
                        _cache[94] || (_cache[94] = createBaseVNode("td", null, "Diferencia:", -1)),
                        createBaseVNode("td", null, "$ " + toDisplayString(familyData.value.income - totalExpenses.value), 1)
                      ]),
                      createBaseVNode("tr", null, [
