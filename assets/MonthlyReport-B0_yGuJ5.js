const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-BYgfSihH.js","assets/QImg-HgQaPOXN.js","assets/index-C_pgiTRk.js","assets/index-DA00BWT3.css","assets/QExpansionItem-BMH_wXA3.js","assets/QItem-BDHnU4rl.js","assets/candidate-store-By-g39go.js","assets/notify-DEfCNxK_.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, o as onMounted, w as watch, P as createElementBlock, I as openBlock, _ as createBaseVNode, H as createBlock, J as withCtx, M as createCommentVNode, O as unref, b4 as defineAsyncComponent, b_ as Suspense, K as createVNode, V as QBtn, R as Fragment, S as renderList, T as toDisplayString, aV as normalizeClass, ag as api, b5 as __vitePreload } from "./index-C_pgiTRk.js";
...
const _sfc_main = {
  ...
  props: ["candidateId"],
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(() => __vitePreload(() => import("./BeneficiaryProfile-BYgfSihH.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0));
    const props = __props;
