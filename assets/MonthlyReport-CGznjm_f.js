const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-B6_KL6_K.js","assets/QImg-BVxkkgtJ.js","assets/index-D8dGxR_o.js","assets/index-DdS7KfM3.css","assets/QExpansionItem-DrplAMFE.js","assets/QItem-C80OgkSj.js","assets/candidate-store-BD2-EgJ1.js","assets/notify-BXzUQ3RT.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, x as onMounted, w as watch, O as createElementBlock, H as openBlock, Z as createBaseVNode, G as createBlock, I as withCtx, L as createCommentVNode, N as unref, b_ as defineAsyncComponent, c2 as Suspense, J as createVNode, U as QBtn, P as Fragment, R as renderList, S as toDisplayString, ab as normalizeClass, a4 as api, b$ as __vitePreload } from "./index-D8dGxR_o.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(
      () => __vitePreload(() => import("./BeneficiaryProfile-B6_KL6_K.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0)
    );
    const props = __props;
