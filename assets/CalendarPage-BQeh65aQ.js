import { am as defineComponent, r as ref, ai as reactive, w as watch, a as computed, g as getCurrentInstance, an as onBeforeUpdate, K as onMounted, ao as nextTick, o as onBeforeUnmount, x as withDirectives, h, ap as Transition, B as createElementBlock, N as createBaseVNode, v as createVNode, D as toDisplayString, t as withCtx, A as unref, F as Fragment, C as renderList, a3 as QDialog, V as api, s as openBlock, G as QBtn, P as normalizeStyle, z as createTextVNode, y as createCommentVNode, q as createBlock, a1 as QCard, X as QCardSection, Q as QIcon } from "./index-CE1zmWGJ.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const today2 = (/* @__PURE__ */ new Date()).toLocaleDateString("mx-MX").replace(/-/g, "/");
    const events = ref([
      {
        id: null,
        candidate_id: null,
            ...
            createBaseVNode("ul", _hoisted_11, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(events.value, (event) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  compararFechas(event.date, unref(today2)) ? (openBlock(), createElementBlock("div", _hoisted_13, toDisplayString(event.date), 1)) : createCommentVNode("", true),
                  compararFechas(event.date, unref(today2)) ? (openBlock(), createElementBlock("div", _hoisted_14, [
...
const CalendarPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-29ef6312"]]);
export {
