import { X as useRoute, r as ref, w as watch, x as onMounted, G as createBlock, H as openBlock, I as withCtx, Z as createBaseVNode, S as toDisplayString, J as createVNode, ac as normalizeClass, U as QBtn, a5 as api } from "./index-BZ01KtdN.js";
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_1, [
                createVNode(QBtn, {
                  ...
                  to: planLinkByType(props2.row.id)
                }, null, 8, ["to"]),
                createVNode(QBtn, {
                  flat: "",
                  round: "",
                  dense: "",
                  icon: "sym_o_edit",
                  to: planLinkByType(props2.row.id, "editar")
                }, null, 8, ["to"])
              ])
            ]),
            _: 2
