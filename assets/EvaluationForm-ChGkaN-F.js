import { a as computed, O as createElementBlock, H as openBlock, Z as createBaseVNode, J as createVNode, N as unref, a8 as QInput, P as Fragment, R as renderList, S as toDisplayString, G as createBlock, r as ref, x as onMounted, a5 as api, w as watch, L as createCommentVNode, I as withCtx, a7 as QCardSection, U as QBtn, ac as normalizeClass, K as withDirectives, M as createTextVNode, aj as QRadio, aO as vShow, a6 as QCard, a4 as useRouter, aa as QCheckbox, $ as normalizeStyle, aP as mergeProps, ab as QDialog } from "./index-Vw2bamBz.js";
...
import { _ as _sfc_main$5 } from "./CandidateProfile-DYfLIGlz.js";
...
const _hoisted_9 = { class: "row q-col-gutter-xl q-mb-xl" };
const _hoisted_10 = { class: "col-12 col-md-3" };
const _hoisted_11 = { class: "col-12 col-md-3" };
const _hoisted_12 = { style: { "margin": "0", "padding": "0 0 0 1rem" } };
const _sfc_main$4 = {
        ...
        createBaseVNode("div", _hoisted_1$4, [
          ...
          createBaseVNode("div", _hoisted_4$2, [
            createVNode(QInput, {
              ...
              modelValue: neurologicalAgeMonths.value + " meses"
            }, null, 8, ["modelValue"])
          ]),
          createBaseVNode("div", _hoisted_5$1, [
            createVNode(QInput, {
              ...
              modelValue: neurologicalAgeYears.value + " años"
            }, null, 8, ["modelValue"])
          ]),
...
const _sfc_main$3 = {
  ...
  props: ["rows", "brainFunctions", "prevRows"],
  setup(__props) {
    const props = __props;
    ...
    const prevCommentsByFunction = computed(() => {
      let comments = {};
      if (!props.prevRows) {
        return [];
      }
      props.prevRows.forEach((row) => {
        props.brainFunctions.forEach((brainFunc) => {
          if (row.ranks[brainFunc.id].comments) {
            comments[brainFunc.id] = comments[brainFunc.id] ? comments[brainFunc.id] + "," + row.ranks[brainFunc.id].comments : row.ranks[brainFunc.id].comments;
          }
    ...
    const allComments = computed(() => {
      let comments = { ...prevCommentsByFunction.value };
      props.brainFunctions.forEach((brainFunc) => {
        let oldVal = Object.hasOwn(comments, brainFunc.id) ? comments[brainFunc.id] : "";
        let newVal = Object.hasOwn(commentsByFunction.value, brainFunc.id) ? commentsByFunction.value[brainFunc.id] : "";
        comments[brainFunc.id] = oldVal ? oldVal + "\n" : "";
        if (newVal) {
          comments[brainFunc.id] = comments[brainFunc.id] + newVal;
        }
      });
      return comments;
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("div", _hoisted_1$3, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(allComments.value), (brainFunctionId) => {
            return openBlock(), createBlock(QInput, {
              ...
              "stack-label": "",
              outlined: "",
              modelValue: allComments.value[brainFunctionId],
              "onUpdate:modelValue": ($event) => allComments.value[brainFunctionId] = $event,
              class: "q-mb-lg"
...
const _hoisted_3$1 = { class: "flex justify-between q-mb-lg" };
const _hoisted_4$1 = { class: "q-pt-lg q-pl-none" };
const _hoisted_5 = { style: { "margin-left": "-10px" } };
const _hoisted_6 = { class: "q-field__bottom text-negative" };
const _sfc_main$2 = {
  __name: "RankForm",
  props: ["rank", "disableP"],
      ...
      return __props.rank ? (openBlock(), createBlock(QCard, {
        ...
        default: withCtx(() => [
          ...
          createVNode(QCardSection, { class: "q-pt-none" }, {
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_2$2, toDisplayString(spec.value), 1),
              createBaseVNode("div", _hoisted_3$1, [
                ...
                createBaseVNode("div", {
                  ...
                  class: normalizeClass(["impact-btn", {
                    "impact-btn--active": localRank.value.caracteristic == "P",
              ...
              createBaseVNode("div", _hoisted_4$1, [
                ...
                withDirectives(createBaseVNode("div", _hoisted_6, " Seleccione lateralidad del impacto ", 512), [
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const disableP = computed(() => {
      ...
      return evaluationFields.value.filter((item) => item.id !== 7).some((item) => {
      ...
      return openBlock(), createBlock(QPage, null, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            _cache[5] || (_cache[5] = createBaseVNode("h1", { class: "page-title q-mb-none" }, "Evaluación", -1)),
            createVNode(QBtn, {
              onClick: print,
              flat: "",
              style: { "color": "grey" },
          ...
          createVNode(_sfc_main$3, {
            rows: rows.value,
            "prev-rows": evaluationFieldsB.value,
            brainFunctions: brainFunctions.value
          }, null, 8, ["rows", "prev-rows", "brainFunctions"]),
          createVNode(QDialog, {
...
const EvaluationForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6f44626d"]]);
export {
