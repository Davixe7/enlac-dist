import { x as onMounted, a as computed, r as ref, a5 as api, G as createBlock, H as openBlock, I as withCtx, a6 as QCard, J as createVNode, a7 as QCardSection, Z as createBaseVNode, Q as QIcon, S as toDisplayString, U as QBtn, a8 as QInput, O as createElementBlock, P as Fragment, R as renderList, M as createTextVNode, ai as QRadio, ab as QDialog, Y as resolveComponent, L as createCommentVNode, af as QCardActions, K as withDirectives, N as unref, F as useAuthStore } from "./index-BZ01KtdN.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    async function storeParentPaymentConfig() {
      try {
        loading.value = false;
        let route = parentPaymentConfig.value.id ? `/sponsorships/${parentPaymentConfig.value.id}` : "sponsorships";
