import { r as ref, o as onMounted, X as createBlock, af as createCommentVNode, a as openBlock, w as withCtx, d as createVNode, b as createBaseVNode, aa as toDisplayString, Q as QBtn, c as createElementBlock, al as normalizeClass, D as withDirectives, g as createTextVNode, E as vShow, N as Notify, ag as useRouter, Z as Fragment, _ as renderList, y as computed, ab as normalizeStyle, u as unref, h as QIcon } from "./index-DqQk-fWJ.js";
import { Q as QTable, a as QTd } from "./QTable-BGQrU0Nt.js";
import { Q as QInput } from "./QInput-Dho-Zk2o.js";
import { l as QDialog } from "./QList-DREGiCrq.js";
import { Q as QPage } from "./QPage-B4fs8O6P.js";
import { api } from "./axios-fPsnLTf7.js";
import { u as useCandidateStore, _ as _sfc_main$3 } from "./CandidateProfile-DZ7seIGQ.js";
import { a as QCardSection, Q as QCard } from "./QCard-3UmZB_01.js";
import { Q as QRadio } from "./QRadio-CiJaESEz.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./QSeparator-BfjasbRm.js";
import "./use-dark-BpW3p9LU.js";
import "./QCheckbox-B6KgEUkB.js";
import "./use-key-composition-BMP8BRP1.js";
import "./selection-BD8QQn2r.js";
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function updateAcceptance() {
      ...
      try {
        ...
        Notify.create({ caption: "Guardado con exito", icon: "sym_o_check_circle", iconColor: "positive", progress: true, timeout: 3e3 });
        emits("close");
...
const _hoisted_4 = { class: "row q-col-gutter-xl q-mb-xl" };
...
const _hoisted_11 = { class: "row q-col-gutter-xl q-mb-xl" };
const _hoisted_12 = { class: "col-12 col-md-3" };
const _hoisted_13 = { class: "col-12 col-md-3" };
const _hoisted_14 = { style: { "margin": "0", "padding": "0 0 0 1rem" } };
const _hoisted_15 = { class: "q-gutter-y-xl" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const neurologicalAge = computed(() => {
      return allRanks.value.reduce((age, rank2) => {
        if (!["F", "P"].includes(rank2.caracteristic)) return age;
        return age + 1;
      }, 0);
    });
    ...
    const damageExtension = computed(() => {
      let brainFunctions2 = { 1: false, 2: false, 3: false, 4: false, 5: false, 6: false };
      allRanks.value.map((rank2) => {
        if (!["F", "0"].includes(rank2.caracteristic)) return;
        brainFunctions2[rank2.brain_function_id] = true;
      });
      let count = Object.values(brainFunctions2).filter((val) => val).length;
      return {
        0: "No hay daño",
        1: "Focal",
    ...
    const damageLaterality = computed(() => {
      ...
      allRanks.value.map((rank2) => {
        if (!["F", "0"].includes(rank2.caracteristic)) return;
        lateralities[rank2.laterality_impact] = true;
      });
    ...
    const damageLevel = computed(() => {
      ...
      allRanks.value.map((rank2) => rank2.caracteristic != "P" ? damageLog[rank2.brain_level_id] = true : "");
      ...
      return openBlock(), createBlock(QPage, null, {
        default: withCtx(() => [
          ...
          !unref(store).loading ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            _cache[8] || (_cache[8] = createBaseVNode("div", { class: "page-title" }, "Diagnostico Funcional", -1)),
            createBaseVNode("div", _hoisted_4, [
              createBaseVNode("div", _hoisted_5, [
                createVNode(QInput, {
                  ...
                  modelValue: unref(store) ? unref(store).chronological_age.split(".")[0] + " meses" : ""
                }, null, 8, ["modelValue"])
              ]),
            ...
            _cache[9] || (_cache[9] = createBaseVNode("div", { class: "page-title" }, "Comentarios de la evaluación", -1)),
...
const EvaluationForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-58e483a7"]]);
export {
