...
import { ad as mergeModels, ae as useModel, r as ref, G as createBlock, H as openBlock, I as withCtx, J as createVNode, a7 as QCardSection, Z as createBaseVNode, O as createElementBlock, L as createCommentVNode, a8 as QInput, U as QBtn, af as QCardActions, a6 as QCard, x as onMounted, N as unref, S as toDisplayString, aj as QRadio, ab as QDialog } from "./index-Vw2bamBz.js";
        ...
        default: withCtx(() => [
          ...
          createVNode(QCardSection, null, {
            default: withCtx(() => [
              ...
              createVNode(QInput, {
                outlined: "",
                modelValue: model.value.locality_name,
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => model.value.locality_name = $event),
                label: "Localidad",
                filled: "",
                class: "q-mb-md"
              }, null, 8, ["modelValue"]),
              createVNode(QInput, {
                ...
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => model.value.transport_location_link = $event),
                label: "Ubicación (Google Maps)",
                filled: "",
                class: "q-mb-md",
                hint: "Pega aquí el enlace de Google Maps"
              }, null, 8, ["modelValue"]),
              model.value.transport_location_link ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
                createVNode(QBtn, {
                  ...
                  outline: "",
                  target: "_blank",
                  href: model.value.transport_location_link,
                  class: "full-width"
                }, null, 8, ["href"])
              ...
              createVNode(QInput, {
                ...
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => model.value.curp = $event),
                label: "CURP",
                filled: ""
              }, null, 8, ["modelValue"])
            ]),
