const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-BwHuCE1d.js","assets/QImg-0LiuKTR0.js","assets/index-BtlleyNg.js","assets/index-DdS7KfM3.css","assets/QExpansionItem-CD1U6xWM.js","assets/QItem-BysEJ2EE.js","assets/candidate-store-DgF_xVB_.js","assets/notify-DLhM6q4g.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, x as onMounted, w as watch, O as createElementBlock, H as openBlock, Z as createBaseVNode, G as createBlock, I as withCtx, L as createCommentVNode, N as unref, bZ as defineAsyncComponent, c1 as Suspense, J as createVNode, U as QBtn, P as Fragment, R as renderList, S as toDisplayString, b3 as normalizeClass, a4 as api, b_ as __vitePreload } from "./index-BtlleyNg.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(
      () => __vitePreload(() => import("./BeneficiaryProfile-BwHuCE1d.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0)
    );
    const props = __props;
