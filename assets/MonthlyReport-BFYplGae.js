const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-96hhvCET.js","assets/QImg-6879-71p.js","assets/index-7AOIawlZ.js","assets/index-DdS7KfM3.css","assets/QExpansionItem-BTB7ryII.js","assets/QItem-CANGy5CK.js","assets/candidate-store-BfGh7qWA.js","assets/notify-CPeSi7Xy.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, x as onMounted, w as watch, O as createElementBlock, H as openBlock, Z as createBaseVNode, G as createBlock, I as withCtx, L as createCommentVNode, N as unref, b_ as defineAsyncComponent, c2 as Suspense, J as createVNode, U as QBtn, P as Fragment, R as renderList, S as toDisplayString, ab as normalizeClass, a4 as api, b$ as __vitePreload } from "./index-7AOIawlZ.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(
      () => __vitePreload(() => import("./BeneficiaryProfile-96hhvCET.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0)
    );
    const props = __props;
