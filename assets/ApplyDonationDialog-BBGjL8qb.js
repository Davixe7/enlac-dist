...
import { r as ref, K as onMounted, V as api, w as watch, q as createBlock, s as openBlock, t as withCtx, v as createVNode, X as QCardSection, N as createBaseVNode, x as withDirectives, G as QBtn, Z as withModifiers, B as createElementBlock, y as createCommentVNode, D as toDisplayString, bT as normalizeProps, bU as guardReactiveProps, z as createTextVNode, Y as QInput, A as unref, F as Fragment, a2 as QCheckbox, a1 as QCard } from "./index-CHo5VICr.js";
import { Q as QBadge } from "./QBadge-CKIrwIVy.js";
import { Q as QItem, a as QItemSection, b as QItemLabel } from "./QItem-CDM0OUtz.js";
...
import { d as date } from "./date-COBI8rpy.js";
import { n as notify } from "./notify-uWCQJ6k7.js";
import { P as PROCURATION_ACTIVITY_TYPES } from "./procurationActivityTypes-Bcf3BSSY.js";
...
const _hoisted_10 = { class: "row q-col-gutter-xs" };
const _hoisted_11 = { key: 6 };
const _hoisted_12 = { class: "row q-col-gutter-xs items-center" };
const _hoisted_13 = { class: "flex items-center" };
const _hoisted_14 = { class: "flex justify-end q-mt-md q-gutter-x-sm" };
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const activityTypes = PROCURATION_ACTIVITY_TYPES;
                  ...
                  createVNode(QMarkupTable, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("tbody", null, [
                        ...
                        createBaseVNode("tr", null, [
                          ...
                          createBaseVNode("td", null, [
                            !form.value.raffle_ticket_id ? (openBlock(), createBlock(QSelect, {
                              ...
                              outlined: "",
                              dense: "",
                              options: unref(activityTypes),
                              "hide-bottom-space": ""
                            }, null, 8, ["modelValue", "options"])) : ticket.value.raffle ? (openBlock(), createBlock(QInput, {
                              key: 1,
                              outlined: "",
                              "hide-bottom-space": "",
                        ...
                        createBaseVNode("tr", null, [
                          ...
                          createBaseVNode("td", null, [
                            !form.value.raffle_ticket_id ? (openBlock(), createBlock(QSelect, {
                              ...
                              "map-options": "",
                              "emit-value": "",
                              disable: !form.value.activity_type || form.value.activity_type === "Padrinos Generales",
                              placeholder: form.value.activity_type === "Padrinos Generales" ? "General (No requiere actividad específica)" : "Seleccione la actividad...",
                              "hide-bottom-space": ""
                            }, null, 8, ["modelValue", "options", "disable", "placeholder"])) : ticket.value.raffle ? (openBlock(), createBlock(QInput, {
                              key: 1,
                              outlined: "",
                              "hide-bottom-space": "",
                        ...
                        form.value.activity_type === "Alcancía" ? (openBlock(), createElementBlock("tr", _hoisted_4, [
                          _cache[32] || (_cache[32] = createBaseVNode("td", { class: "text-bold" }, "Fecha de Revisión", -1)),
                          createBaseVNode("td", null, [
                            createVNode(QInput, {
                              modelValue: form.value.review_date,
                              "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => form.value.review_date = $event),
                              type: "date",
                              outlined: "",
                              dense: "",
                              "hide-bottom-space": ""
                        ...
                        form.value.activity_type === "Boteo" ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                          createBaseVNode("tr", null, [
                            _cache[33] || (_cache[33] = createBaseVNode("td", { class: "text-bold" }, "Área de Boteo", -1)),
                            createBaseVNode("td", null, [
                              createVNode(QInput, {
                                modelValue: form.value.boteo_area,
                                "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => form.value.boteo_area = $event),
                                outlined: "",
                                dense: "",
                          ...
                          createBaseVNode("tr", null, [
                            _cache[34] || (_cache[34] = createBaseVNode("td", { class: "text-bold" }, "No. de Bote / 10%", -1)),
                            createBaseVNode("td", null, [
                              createBaseVNode("div", _hoisted_5, [
                                createVNode(QInput, {
                                  modelValue: form.value.boteo_can_number,
                                  "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => form.value.boteo_can_number = $event),
                                  outlined: "",
                                  dense: "",
                                ...
                                createVNode(QInput, {
                                  ...
                                  "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => form.value.boteo_ten_percent = $event),
                                  outlined: "",
                                  dense: "",
                        ...
                        form.value.activity_type === "Alianza" || form.value.activity_type === "Fundaciones" ? (openBlock(), createElementBlock("tr", _hoisted_6, [
                          _cache[35] || (_cache[35] = createBaseVNode("td", { class: "text-bold" }, "Proyecto", -1)),
                          createBaseVNode("td", null, [
                            createVNode(QInput, {
                              modelValue: form.value.project_name,
                              "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => form.value.project_name = $event),
                              outlined: "",
                              dense: "",
                        ...
                        form.value.activity_type === "Programa de Verano" || form.value.activity_type === "Natación" ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
                          createBaseVNode("tr", null, [
                            _cache[36] || (_cache[36] = createBaseVNode("td", { class: "text-bold" }, "Beneficiario", -1)),
                            createBaseVNode("td", null, [
                              createVNode(QSelect, {
                                modelValue: form.value.beneficiary_id,
                                "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => form.value.beneficiary_id = $event),
                                "use-input": "",
                                clearable: "",
                                "input-debounce": "300",
                                outlined: "",
                                ...
                                "selected-item": withCtx((scope) => [
                                  scope.opt ? (openBlock(), createElementBlock("span", _hoisted_7, toDisplayString(scope.opt.label), 1)) : createCommentVNode("", true)
                                ]),
                                _: 1
                          ...
                          createBaseVNode("tr", null, [
                            _cache[37] || (_cache[37] = createBaseVNode("td", { class: "text-bold" }, "Nombre Externo", -1)),
                            createBaseVNode("td", null, [
                              createVNode(QInput, {
                                modelValue: form.value.external_name,
                                "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => form.value.external_name = $event),
                                outlined: "",
                                dense: "",
                          ...
                          createBaseVNode("tr", null, [
                            _cache[38] || (_cache[38] = createBaseVNode("td", { class: "text-bold" }, "Grupo", -1)),
                            createBaseVNode("td", null, [
                              createVNode(QInput, {
                                modelValue: form.value.group_name,
                                "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => form.value.group_name = $event),
                                outlined: "",
                                dense: "",
                        ...
                        form.value.activity_type === "Organismos de Gobierno" ? (openBlock(), createElementBlock("tr", _hoisted_8, [
                          _cache[39] || (_cache[39] = createBaseVNode("td", { class: "text-bold" }, "Nombre de Institución", -1)),
                          createBaseVNode("td", null, [
                            createVNode(QInput, {
                              modelValue: form.value.government_institution_name,
                              "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => form.value.government_institution_name = $event),
                              outlined: "",
                              dense: "",
                        ...
                        createBaseVNode("tr", null, [
                          _cache[40] || (_cache[40] = createBaseVNode("td", { class: "text-bold" }, "Concepto", -1)),
                          createBaseVNode("td", null, [
                            createVNode(QInput, {
                              modelValue: form.value.concept,
                              "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => form.value.concept = $event),
                              outlined: "",
                              dense: "",
                              type: "textarea",
                              rows: "2",
                        ...
                        createBaseVNode("tr", null, [
                          _cache[41] || (_cache[41] = createBaseVNode("td", { class: "text-bold" }, "Fecha / Método", -1)),
                          createBaseVNode("td", null, [
                            createBaseVNode("div", _hoisted_9, [
                              createVNode(QInput, {
                                modelValue: form.value.payment_date,
                                "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => form.value.payment_date = $event),
                                outlined: "",
                                dense: "",
                                type: "date",
                                class: "col-6",
                              ...
                              createVNode(QSelect, {
                                ...
                                "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => form.value.payment_method = $event),
                                outlined: "",
                                dense: "",
                        ...
                        createBaseVNode("tr", null, [
                          _cache[42] || (_cache[42] = createBaseVNode("td", { class: "text-bold" }, "Monto / Moneda", -1)),
                          createBaseVNode("td", null, [
                            createBaseVNode("div", _hoisted_10, [
                              createVNode(QInput, {
                                modelValue: form.value.amount,
                                "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => form.value.amount = $event),
                              ...
                              createVNode(QSelect, {
                                ...
                                "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => form.value.currency = $event),
                                outlined: "",
                                dense: "",
                                options: ["MXN", "DLLS"],
                                class: "col-6",
                        ...
                        form.value.currency === "DLLS" ? (openBlock(), createElementBlock("tr", _hoisted_11, [
                          _cache[43] || (_cache[43] = createBaseVNode("td", { class: "text-bold" }, "Tipo de Cambio", -1)),
                          createBaseVNode("td", null, [
                            createBaseVNode("div", _hoisted_12, [
                              createVNode(QInput, {
                                modelValue: form.value.exchange_rate,
                                "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => form.value.exchange_rate = $event),
                                modelModifiers: { number: true },
                                outlined: "",
                                dense: "",
                                type: "number",
                        ...
                        createBaseVNode("tr", null, [
                          _cache[44] || (_cache[44] = createBaseVNode("td", { class: "text-bold" }, "Referencia", -1)),
                          createBaseVNode("td", null, [
                            createVNode(QInput, {
                              modelValue: form.value.reference,
                              "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => form.value.reference = $event),
                              outlined: "",
                              dense: "",
                        ...
                        createBaseVNode("tr", null, [
                          _cache[45] || (_cache[45] = createBaseVNode("td", { class: "text-bold" }, "¿Deducible?", -1)),
                          createBaseVNode("td", _hoisted_13, [
                            createVNode(QCheckbox, {
                              modelValue: form.value.has_tax_receipt,
                              "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => form.value.has_tax_receipt = $event),
