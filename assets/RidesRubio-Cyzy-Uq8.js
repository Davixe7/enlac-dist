import { r as ref, K as onMounted, V as api, B as createElementBlock, N as createBaseVNode, v as createVNode, t as withCtx, Y as QInput, a3 as QDialog, F as Fragment, s as openBlock, Q as QIcon, G as QBtn, z as createTextVNode, a9 as QSpinner, a1 as QCard, X as QCardSection, x as withDirectives } from "./index-CnS-WeK3.js";
  ...
  setup(__props) {
    ...
    const columns = ref([
      ...
      },
      {
        name: "address",
        label: "Direccion",
        field: (row) => row.candidate.location_detail.transport_address
      },
      {
        name: "link",
        label: "Ubicacion",
        field: (row) => row.candidate.location_detail.transport_location_link
      },
      {
        name: "departure_time",
        label: "Ida",
    ...
    async function fetchRides() {
      try {
        loading.value = true;
        rows.value = (await api.get("rides/?type=rubio")).data.data;
      } catch (error) {
        console.log(error);
      } finally {
        loading.value = false;
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          _cache[3] || (_cache[3] = createBaseVNode("div", { class: "column" }, [
            createBaseVNode("h1", { class: "page-title" }, "Traslados Cuauhtémoc / Rubio"),
          ...
          "body-cell-link": withCtx((props) => [
            createVNode(QTd, null, {
              default: withCtx(() => [
                ...
                }, " Ver en Google Maps ", 8, _hoisted_4)
              ]),
              _: 2
            }, 1024)
          ]),
