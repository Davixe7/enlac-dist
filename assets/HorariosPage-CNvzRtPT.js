import { r as ref, A as computed, o as onMounted, q as createBlock, w as withCtx, k as api, a as openBlock, b as createBaseVNode, d as createVNode, l as QCard, m as QCardSection, j as createTextVNode, ap as QSeparator, c as createElementBlock, H as Fragment, K as renderList, t as toDisplayString, h as QBtn, s as QDialog, E as createCommentVNode } from "./index-Dk-vfK7v.js";
import { d as date, Q as QDate } from "./QDate-DdVmQPko.js";
...
import { _ as _sfc_main$1 } from "./BeneficiariesPicker-DjWaveUV.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    async function fetchSchedules() {
      ...
      try {
        loading.value = true;
        schedules.value = (await api.get(`equinotherapy_schedules/?date=${selectedDate.value}`)).data.schedules;
      } catch (error) {
        console.log(error);
