import { Q as QTooltip } from "./QTooltip-Dkng4TgY.js";
import { aT as noop, c as createComponent, b5 as useTransitionProps, c4 as nonRoundBtnProps, g as getCurrentInstance, r as ref, b2 as useId, a as computed, S as getBtnDesignAttr, w as watch, K as onMounted, h, Q as QIcon, b as hSlot, G as QBtn, bM as stop, bK as shouldIgnoreKey, bi as prevent, a4 as useDarkProps, a5 as useDark, c5 as useSplitAttrs, o as onBeforeUnmount, a_ as stopAndPrevent, ap as nextTick, be as addFocusFn, q as createBlock, s as openBlock, t as withCtx, N as createBaseVNode, y as createCommentVNode, v as createVNode, B as createElementBlock, A as unref, z as createTextVNode, D as toDisplayString, Y as QInput, am as QRadio, C as renderList, a2 as QCheckbox, F as Fragment, _ as normalizeClass, V as api } from "./index-CnS-WeK3.js";
import { Q as QSelect } from "./QSelect-DXvU-ucL.js";
import { a as QItemSection, Q as QItem } from "./QItem-DX9D2juO.js";
import { Q as QList } from "./QList-D7FMqI51.js";
import { Q as QBtnGroup } from "./QBtnGroup-CDclmEN-.js";
import { Q as QMenu } from "./QMenu-tq1EQicO.js";
import { u as useFullscreenEmits, a as useFullscreenProps, b as useFullscreen } from "./use-fullscreen-a6WA4gkW.js";
...
import { u as useCandidateStore } from "./candidate-store-C94lLppO.js";
import { _ as _sfc_main$2 } from "./MedicationsPage-DbeoeXE2.js";
import { _ as _sfc_main$1 } from "./CandidateProfile-CjtHkoqm.js";
...
const _hoisted_7 = { class: "label-alt" };
const _hoisted_8 = { class: "flex column justify-between q-px-md q-gutter-y-md" };
const _hoisted_9 = { style: { "margin-left": "-8px" } };
const _hoisted_10 = {
  class: "row q-mb-xl",
...
const _hoisted_12 = {
  ...
  style: { "position": "sticky", "top": "144px", "height": "calc(100vh - 144px)", "display": "flex", "flex-flow": "column", "min-height": "0" }
};
const _hoisted_13 = { class: "flex q-mb-xl" };
const _hoisted_14 = ["onClick"];
const _hoisted_15 = { class: "q-mb-xl" };
const _hoisted_16 = { class: "q-mb-xl" };
const _hoisted_17 = {
  key: 1,
  class: "flex justify-end items-center q-py-xl"
};
const _hoisted_18 = { class: "q-mr-lg" };
const _hoisted_19 = {
  key: 0,
  class: "q-mr-lg"
};
const _hoisted_20 = { key: 2 };
const _hoisted_21 = { class: "label-alt" };
const _sfc_main = {
      ...
      return openBlock(), createBlock(QPage, null, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            _cache[16] || (_cache[16] = createBaseVNode("div", { class: "div" }, [
              createBaseVNode("div", { class: "page-title q-mb-none" }, "Entrevista")
            ], -1)),
            createBaseVNode("div", _hoisted_2, [
              !interview.value.signed_at && unref(store).status == "pendiente" ? (openBlock(), createElementBlock("div", _hoisted_3, [
                createBaseVNode("div", _hoisted_4, [
                  createVNode(QTooltip, {
                    ...
                    default: withCtx(() => _cache[14] || (_cache[14] = [
                      createTextVNode(" Al guardarlo podrá seguir editando ")
                    ])),
                    _: 1
                  }),
                  createVNode(QIcon, {
                  ...
                  createVNode(QBtn, {
                    ...
                    outline: "",
                    color: "primary",
                    onClick: _cache[0] || (_cache[0] = ($event) => storeInterview()),
                    label: "Guardar"
                  }, null, 8, ["loading"])
                ]),
                interview.value.id ? (openBlock(), createElementBlock("div", _hoisted_5, [
                  createVNode(QTooltip, {
                    anchor: "top right",
                    self: "bottom end",
                    class: "bg-black text-white q-py-sm q-px-md",
                    ...
                    default: withCtx(() => _cache[15] || (_cache[15] = [
                      createTextVNode(" Al firmar ya no podrá editarlo ")
                    ])),
                    _: 1
                  }),
                  createVNode(QIcon, {
                  ...
                  createVNode(QBtn, {
                    loading: loading.value,
                    color: "primary",
                    onClick: _cache[1] || (_cache[1] = ($event) => signInterview()),
                    label: "Firmar"
                  }, null, 8, ["loading"])
                ])) : createCommentVNode("", true)
              ])) : (openBlock(), createElementBlock("div", _hoisted_6, [
                createBaseVNode("div", _hoisted_7, "Firmado el: " + toDisplayString(interview.value.signed_at), 1)
              ]))
            ])
          ]),
          unref(store).status ? (openBlock(), createBlock(_sfc_main$1, {
            key: 0,
              ...
              createBaseVNode("div", _hoisted_8, [
                createBaseVNode("div", null, [
                  createVNode(QInput, {
                    ...
                    outlined: "",
                    "stack-label": "",
                    modelValue: interviewee.value.name,
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => interviewee.value.name = $event),
                    error: !!errors.value["interviewee.name"],
                    "error-message": errors.value["interviewee.name"]
                ...
                createBaseVNode("div", null, [
                  createVNode(QSelect, {
                    ...
                    "hide-bottom-space": "",
                    label: "Parentesco",
                    modelValue: interviewee.value.relationship,
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => interviewee.value.relationship = $event),
                    error: !!errors.value["interviewee.relationship"],
                    "error-message": errors.value["interviewee.relationship"],
                ...
                createBaseVNode("div", _hoisted_9, [
                  createVNode(QRadio, {
                    modelValue: interviewee.value.legal_relationship,
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => interviewee.value.legal_relationship = $event),
                    val: "biologico",
                  ...
                  createVNode(QRadio, {
                    modelValue: interviewee.value.legal_relationship,
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => interviewee.value.legal_relationship = $event),
                    val: "adoptivo",
                    label: "Hijo Adoptivo"
                  }, null, 8, ["modelValue"])
                ])
            ...
            _: 1
          }, 8, ["candidate-id", "errors"])) : createCommentVNode("", true),
          _cache[21] || (_cache[21] = createBaseVNode("div", { class: "label-alt-2" }, "Lista de preguntas", -1)),
          createBaseVNode("div", _hoisted_10, [
                        ...
                        createVNode(QItemSection, {
                          ...
                          default: withCtx(() => [
                            createVNode(QCheckbox, {
                              ...
                              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => interview.value.answers = $event),
                              val: question.id
            ...
            createBaseVNode("div", _hoisted_12, [
              createVNode(QEditor, {
                ...
                "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => interview.value.content = $event),
                disable: Boolean(interview.value.signed_at),
                class: normalizeClass({ "has-errors": !!errors.value.content, "q-field--error": !!errors.value.content }),
                "error-message": errors.value.content,
                style: { "height": "100%", "overflow-y": "scroll" }
              }, null, 8, ["modelValue", "disable", "class", "error-message"])
            ])
          ]),
          _cache[22] || (_cache[22] = createBaseVNode("div", { class: "label-alt" }, "29 - Que calificacion APGAR tuvo al nacer? Seleccione una opción", -1)),
          createBaseVNode("div", _hoisted_13, [
            (openBlock(), createElementBlock(Fragment, null, renderList(10, (n) => {
              ...
              }, toDisplayString(n), 11, _hoisted_14);
            }), 64))
          ]),
          _cache[23] || (_cache[23] = createBaseVNode("div", { class: "label-alt" }, "30 - Lista de medicamentos que toma, ¿hay alguno adicional?", -1)),
          createVNode(_sfc_main$2, {
            modelValue: unref(store).medications,
            "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => unref(store).medications = $event),
            candidateId: props.candidateId,
            errors: errors.value
          }, null, 8, ["modelValue", "candidateId", "errors"]),
          _cache[24] || (_cache[24] = createBaseVNode("div", { class: "label-alt" }, "31 - ¿Controla esfínteres?", -1)),
          createBaseVNode("div", _hoisted_15, [
            createVNode(QRadio, {
              modelValue: interview.value.sphincters_control,
              "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => interview.value.sphincters_control = $event),
              label: "Si",
              val: 1,
            ...
            createVNode(QRadio, {
              modelValue: interview.value.sphincters_control,
              "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => interview.value.sphincters_control = $event),
              label: "No",
              val: 0,
              disable: !!interview.value.signed_at
            }, null, 8, ["modelValue", "disable"])
          ]),
          _cache[25] || (_cache[25] = createBaseVNode("div", { class: "label-alt" }, "31 - Observaciones adicionales por parte del evaluador:", -1)),
          createBaseVNode("div", _hoisted_16, [
            createVNode(QInput, {
              outlined: "",
              type: "textarea",
              modelValue: interview.value.observation,
              "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => interview.value.observation = $event),
              disable: !!interview.value.signed_at,
              readonly: !!interview.value.signed_at
            }, null, 8, ["modelValue", "disable", "readonly"])
          ]),
          !interview.value.signed_at && unref(store).status == "pendiente" ? (openBlock(), createElementBlock("div", _hoisted_17, [
            createBaseVNode("div", _hoisted_18, [
              ...
              createVNode(QBtn, {
                ...
                outline: "",
                color: "primary",
                onClick: _cache[12] || (_cache[12] = ($event) => storeInterview())
              }, {
            ...
            interview.value.id ? (openBlock(), createElementBlock("div", _hoisted_19, [
              createVNode(QTooltip, {
                anchor: "top right",
                self: "bottom end",
                class: "bg-black text-white q-py-sm q-px-md",
              ...
              createVNode(QBtn, {
                loading: loading.value,
                color: "primary",
                onClick: _cache[13] || (_cache[13] = ($event) => signInterview())
              }, {
            ...
            createBaseVNode("div", _hoisted_21, "Firmado el: " + toDisplayString(interview.value.signed_at), 1)
          ]))
        ]),
        _: 1
      });
