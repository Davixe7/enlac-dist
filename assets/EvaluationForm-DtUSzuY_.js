import { p as computed, c as createElementBlock, a as openBlock, b as createBaseVNode, d as createVNode, g as unref, F as Fragment, C as renderList, t as toDisplayString, l as createBlock, r as ref, o as onMounted, i as api, x as createCommentVNode, w as withCtx, Q as QBtn, G as normalizeClass, y as withDirectives, h as createTextVNode, z as vShow, B as useRouter, H as normalizeStyle, I as mergeProps } from "./index-BohS6BTj.js";
...
import { _ as _sfc_main$5 } from "./CandidateProfile-Dg_eySEr.js";
import { Q as QInput } from "./QInput-rhPFqdXf.js";
import { a as QCardSection, Q as QCard } from "./QCard-2LFzadz4.js";
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    onMounted(async () => {
      ...
      localCandidate.value.admission_status = localCandidate.value.admission_status == null ? 1 : localCandidate.value.admission_status;
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_1$1, [
                createVNode(QRadio, {
                  label: "Si",
                  val: 1,
                  modelValue: localCandidate.value.admission_status,
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => localCandidate.value.admission_status = $event)
                }, null, 8, ["modelValue"]),
                createVNode(QRadio, {
                  label: "No",
                  val: 0,
                  modelValue: localCandidate.value.admission_status,
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => localCandidate.value.admission_status = $event)
                }, null, 8, ["modelValue"])
              ]),
              localCandidate.value.admission_status ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              createVNode(QInput, {
                ...
                "stack-label": "",
                type: "textarea",
                label: localCandidate.value.admission_status ? "Comentarios (opcionales)" : "¿Por qué no?",
