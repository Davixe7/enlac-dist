import { g as getCurrentInstance, r as ref, K as onMounted, q as createBlock, s as openBlock, t as withCtx, v as createVNode, a1 as QCard, X as QCardSection, N as createBaseVNode, Y as QInput, ac as QCardActions, G as QBtn, A as unref, a3 as QDialog, V as api } from "./index-D0yVl0M9.js";
    ...
    async function onSave() {
      try {
        ...
        await api.post(`candidatestatuses/${form.value.id}`, {
          ...
          status: "programado",
          comment: form.value.observations,
          _method: "PUT"
        });
        onDialogOK({
          id: form.value.id,
