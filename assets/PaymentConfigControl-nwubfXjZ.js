...
import { G as useAuthStore, r as ref, a as computed, w as watch, o as onMounted, ag as api, P as createElementBlock, I as openBlock, K as createVNode, J as withCtx, _ as createBaseVNode, M as createCommentVNode, R as Fragment, S as renderList, ah as QCard, ai as QCardSection, T as toDisplayString, as as QRadio, al as QInput, O as unref, V as QBtn, am as QDialog, aV as normalizeClass } from "./index-sn_6H7kT.js";
        ...
        createVNode(QMarkupTable, {
          ...
          default: withCtx(() => [
            ...
            rows.value && rows.value.length ? (openBlock(), createElementBlock("tbody", _hoisted_1, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(configs.value).reverse(), (sponsorId) => {
                return openBlock(), createElementBlock("tr", { key: sponsorId }, [
                  createBaseVNode("td", null, toDisplayString(sponsorId != "" ? rows.value.find((r) => r.sponsor?.id == sponsorId).sponsor.full_name : "Cuota de padres"), 1),
                  configs.value[sponsorId] ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(Object.keys(configs.value[sponsorId]), (month) => {
                    return openBlock(), createElementBlock("td", {
                      key: month,
                      class: normalizeClass([`bg-${payment.value.status}-2`]),
                      onClick: ($event) => true ? setPayment(sponsorId) : ""
                    }, [
                      createBaseVNode("div", _hoisted_3, [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(configs.value[sponsorId][month], (payment2) => {
                          return openBlock(), createElementBlock("div", {
                            key: payment2.id,
                            style: { "flex": "1 1 auto" },
                            class: normalizeClass([`bg-${payment2.status}-2`])
                          }, toDisplayString(payment2.abono), 3);
                        }), 128))
                      ])
                    ], 10, _hoisted_2);
              ...
              candidate.value.id ? (openBlock(), createElementBlock("tr", _hoisted_4, [
...
const PaymentConfigControl = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d73aae52"]]);
export {
