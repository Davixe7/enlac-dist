import { r as ref, a as computed, x as onMounted, G as createBlock, I as withCtx, a5 as api, H as openBlock, Z as createBaseVNode, J as createVNode, a6 as QCard, a7 as QCardSection, M as createTextVNode, T as QSeparator, O as createElementBlock, P as Fragment, R as renderList, S as toDisplayString, U as QBtn, ab as QDialog, L as createCommentVNode } from "./index-BZ01KtdN.js";
...
import { d as date } from "./date-Y2alOFYy.js";
                  ...
                  createBaseVNode("tbody", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row, i) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", null, toDisplayString(row.id ? formatTime(row.departure_time) : "-"), 1),
                        createBaseVNode("td", null, toDisplayString(row.id ? formatTime(row.return_time) : "-"), 1),
                        createBaseVNode("td", null, toDisplayString(row.id ? row.comments || "Sin comentarios" : "-"), 1)
                      ]);
                    }), 128))
                  ])
                ]),
              ...
              createVNode(QCard, { style: { "width": "400px" } }, {
                default: withCtx(() => [
                  ...
                  createVNode(QCardSection, null, {
                    default: withCtx(() => [
                      _cache[9] || (_cache[9] = createBaseVNode("div", { class: "q-pb-sm q-field__label" }, "Seleccionar beneficiario", -1)),
                      ...
                      selectedRow.value.candidate_id ? (openBlock(), createElementBlock("div", _hoisted_5, [
                        createBaseVNode("table", _hoisted_6, [
                          createBaseVNode("tr", null, [
                            _cache[6] || (_cache[6] = createBaseVNode("th", null, "Fecha:", -1)),
                            createBaseVNode("td", _hoisted_7, toDisplayString(selectedRow.value.date), 1)
                          ]),
                          createBaseVNode("tr", null, [
                            _cache[7] || (_cache[7] = createBaseVNode("th", null, "Hora inicio:", -1)),
                            createBaseVNode("td", _hoisted_8, toDisplayString(formattedStartTime.value), 1)
                          ]),
                          createBaseVNode("tr", null, [
                            _cache[8] || (_cache[8] = createBaseVNode("th", null, "Hora fin:", -1)),
                            createBaseVNode("td", _hoisted_9, toDisplayString(formattedEndTime.value), 1)
                          ])
                        ]),
