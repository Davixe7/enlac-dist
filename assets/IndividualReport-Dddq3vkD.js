...
import { r as ref, a as computed, x as onMounted, X as useRoute, a5 as api, w as watch, G as createBlock, H as openBlock, I as withCtx, Z as createBaseVNode, J as createVNode, L as createCommentVNode, N as unref, U as QBtn, S as toDisplayString, O as createElementBlock, R as renderList, P as Fragment, M as createTextVNode } from "./index-BZ01KtdN.js";
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(planCategories.value, (category) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    scores.value.hasOwnProperty(category.id) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      ...
                      category.id != "totals" ? (openBlock(), createElementBlock("td", _hoisted_3, [
                        createVNode(QBadge, { color: "positive" }, {
                          default: withCtx(() => [
...
const IndividualReport = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cc9d4604"]]);
export {
