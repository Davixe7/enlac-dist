import { ad as mergeModels, ae as useModel, O as createElementBlock, H as openBlock, Z as createBaseVNode, J as createVNode, L as createCommentVNode, a8 as QInput, r as ref, a as computed, x as onMounted, a5 as api, G as createBlock, I as withCtx, a7 as QCardSection, ag as withModifiers, aa as QCheckbox, aj as QRadio, U as QBtn, a6 as QCard } from "./index-Vw2bamBz.js";
...
const _hoisted_5$1 = {
  class: "row q-col-gutter-x-md q-mb-md",
  style: { "display": "none" }
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        _cache[14] || (_cache[14] = createBaseVNode("div", {
          class: "form-section-label q-mb-none",
          style: { "display": "none" }
        }, " Domicilio ", -1)),
        ...
        model.value.fiscalStatus ? (openBlock(), createElementBlock("div", _hoisted_8$1, [
          createBaseVNode("a", {
            target: "_blank",
            href: model.value.fiscalStatus
          }, "Descargar adjunto actual", 8, _hoisted_9$1)
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    onMounted(async () => {
      ...
      let route = props.paymentConfigId ? `/sponsorships/${props.paymentConfigId}` : `/sponsorships/?candidate_id=${props.candidateId}&sponsor_id=${props.sponsorId}`;
      ...
      return openBlock(), createBlock(QCard, {
        ...
        default: withCtx(() => [
          createVNode(QCardSection, null, {
            default: withCtx(() => [
              _cache[24] || (_cache[24] = createBaseVNode("h1", { class: "page-title q-pb-md" }, "Niveles de Aportación", -1)),
              createVNode(QForm, {
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_1, [
                    _cache[12] || (_cache[12] = createBaseVNode("label", { for: "#" }, "Cantidad", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      ...
                      append: withCtx(() => _cache[11] || (_cache[11] = [
                        createBaseVNode("div", { class: "text-caption" }, "MXN", -1)
                      ])),
                      _: 1
                    }, 8, ["modelValue", "error", "error-message"])
                  ]),
                  createBaseVNode("div", _hoisted_2, [
                    _cache[14] || (_cache[14] = createBaseVNode("label", { for: "#" }, "Cantidad en dolares", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      class: "q-field--required",
                      modelValue: paymentConfig.value.amount_usd,
                      "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => paymentConfig.value.amount_usd = $event),
                      "hide-bottom-space": "",
                      error: !!errors.value.amount_usd,
                      "error-message": errors.value.amount_usd
                    }, {
                      append: withCtx(() => _cache[13] || (_cache[13] = [
                        createBaseVNode("div", { class: "text-caption" }, "USD", -1)
                      ])),
                      _: 1
                    }, 8, ["modelValue", "error", "error-message"])
                  ]),
                  createBaseVNode("div", _hoisted_3, [
                    _cache[15] || (_cache[15] = createBaseVNode("label", { for: "#" }, "Frecuencia del donativo", -1)),
                    createVNode(QSelect, {
                      outlined: "",
                      dense: "",
                      ...
                      "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => paymentConfig.value.frequency = $event),
                      "option-label": "label",
                      "option-value": "val",
                      "map-options": "",
                      "emit-value": "",
                  ...
                  createBaseVNode("div", _hoisted_4, [
                    _cache[16] || (_cache[16] = createBaseVNode("label", { for: "#" }, "Aportacion Anual", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      "stack-label": "",
                  ...
                  createBaseVNode("div", _hoisted_5, [
                    _cache[17] || (_cache[17] = createBaseVNode("label", { for: "#" }, "Impacto mensual en cuota del beneficiario", -1)),
                    createVNode(QInput, {
                      outlined: "",
                  ...
                  createBaseVNode("div", _hoisted_6, [
                    _cache[18] || (_cache[18] = createBaseVNode("label", { for: "#" }, "¿Qué día del mes será su aportación?", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      "stack-label": "",
                      modelValue: paymentConfig.value.month_payday,
                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => paymentConfig.value.month_payday = $event),
                      type: "number",
                      "hide-bottom-space": "",
                  ...
                  createBaseVNode("div", _hoisted_7, [
                    _cache[19] || (_cache[19] = createBaseVNode("label", { for: "#" }, "¿Requiere que pasen a recoger su donativo?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QCheckbox, {
                        modelValue: paymentConfig.value.wants_pickup,
                        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => paymentConfig.value.wants_pickup = $event),
                        "true-value": 1,
                        "false-value": 0
                      }, null, 8, ["modelValue"])
                    ])
                  ...
                  createBaseVNode("div", _hoisted_8, [
                    _cache[20] || (_cache[20] = createBaseVNode("label", { for: "#" }, "¿A cual domicilio?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QRadio, {
                  ...
                  createBaseVNode("div", _hoisted_9, [
                    _cache[21] || (_cache[21] = createBaseVNode("label", { for: "#" }, "¿Desea un recordatorio?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QCheckbox, {
                        modelValue: paymentConfig.value.wants_reminder,
                        "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => paymentConfig.value.wants_reminder = $event),
                        "true-value": 1,
                        "false-value": 0
                      }, null, 8, ["modelValue"])
                    ])
                  ...
                  createBaseVNode("div", _hoisted_10, [
                    _cache[22] || (_cache[22] = createBaseVNode("label", { for: "#" }, "¿Desea un recibo deducible?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QCheckbox, {
                        modelValue: paymentConfig.value.wants_deductible_receipt,
                        "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => paymentConfig.value.wants_deductible_receipt = $event),
                        "true-value": 1,
                        "false-value": 0
                      }, null, 8, ["modelValue"])
                    ])
                  ]),
                  paymentConfig.value.wants_deductible_receipt ? (openBlock(), createElementBlock("div", _hoisted_11, [
                    _cache[23] || (_cache[23] = createBaseVNode("div", { class: "form-section-label q-mb-none" }, "Recibo deducible", -1)),
                    createVNode(_sfc_main$1, {
                      modelValue: paymentConfig.value.receipt,
                      "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => paymentConfig.value.receipt = $event),
                      errors: errors.value
