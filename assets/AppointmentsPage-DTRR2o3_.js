import { r as ref, a as computed, o as onMounted, ag as api, P as createElementBlock, I as openBlock, _ as createBaseVNode, K as createVNode, V as QBtn, J as withCtx, am as QDialog, H as createBlock, M as createCommentVNode, ai as QCardSection, al as QInput, ah as QCard, R as Fragment } from "./index-BZblXE-E.js";
import { Q as QTable } from "./QTable-BOV3mGZJ.js";
import { Q as QTd } from "./QTd-DrME39BD.js";
import { _ as _sfc_main$1 } from "./AppointmentForm-Crn86sLg.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        _cache[11] || (_cache[11] = createBaseVNode("h1", { class: "page-subtitle" }, "Citas pendientes", -1)),
        createVNode(QTable, {
          class: "q-mb-xl",
        ...
        _cache[12] || (_cache[12] = createBaseVNode("h1", { class: "page-subtitle" }, "Citas previas", -1)),
        createVNode(QTable, {
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => dialog2.value = $event)
        }, {
          default: withCtx(() => [
            appointment.value ? (openBlock(), createBlock(QCard, {
              ...
              default: withCtx(() => [
                createVNode(QCardSection, { class: "flex items-center" }, {
                  default: withCtx(() => [
                    _cache[10] || (_cache[10] = createBaseVNode("div", { class: "page-subtitle" }, "Detalles de la cita", -1)),
                    createVNode(QBtn, {
                      flat: "",
                      round: "",
                      dense: "",
                    ...
                    createBaseVNode("div", _hoisted_2, [
                      createBaseVNode("div", _hoisted_3, [
                        ...
                        createVNode(QInput, {
                          ...
                          "hide-bottom-space": "",
                          label: "Tipo de Cita",
                          modelValue: appointment.value.type,
                          "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => appointment.value.type = $event),
                          readonly: ""
                        }, null, 8, ["modelValue"]),
                        createVNode(QInput, {
                          outlined: "",
                          ...
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => appointment.value.evaluator.name = $event),
                          readonly: ""
                        }, null, 8, ["modelValue"])
                      ]),
                      createBaseVNode("div", _hoisted_4, [
                        createVNode(QInput, {
                          ...
                          "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => appointment.value.comments = $event),
                          type: "textarea",
                          rows: 8
                        }, null, 8, ["modelValue"])
                      ])
                ...
                createVNode(QCardSection, { class: "flex justify-end" }, {
                  default: withCtx(() => [
                    createVNode(QBtn, {
                      outline: "",
                      color: "primary",
                      onClick: _cache[7] || (_cache[7] = ($event) => dialog2.value = false),
                      label: "Cerrar",
                      class: "q-mr-sm"
                    }),
                    createVNode(QBtn, {
