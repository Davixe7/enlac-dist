...
import { aj as mergeModels, ak as useModel, P as createElementBlock, I as openBlock, _ as createBaseVNode, K as createVNode, M as createCommentVNode, al as QInput, r as ref, a as computed, o as onMounted, ag as api, H as createBlock, J as withCtx, ai as QCardSection, ap as withModifiers, aq as QCheckbox, as as QRadio, V as QBtn, ah as QCard } from "./index-sn_6H7kT.js";
              ...
              createVNode(QForm, {
                ...
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_1, [
                    _cache[11] || (_cache[11] = createBaseVNode("label", { for: "#" }, "Cantidad", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      class: "q-field--required",
                      modelValue: paymentConfig.value.amount,
                      "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => paymentConfig.value.amount = $event),
                      "hide-bottom-space": "",
                      ...
                      append: withCtx(() => [
                        createVNode(QSelect, {
                          ...
                          "hide-bottom-space": "",
                          options: ["mxn", "usd"],
                          modelValue: paymentConfig.value.currency,
                          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => paymentConfig.value.currency = $event)
                        }, null, 8, ["modelValue"])
                      ]),
                      _: 1
                  ...
                  createBaseVNode("div", _hoisted_2, [
                    _cache[12] || (_cache[12] = createBaseVNode("label", { for: "#" }, "Frecuencia del donativo", -1)),
                    createVNode(QSelect, {
                      outlined: "",
                      dense: "",
                  ...
                  createBaseVNode("div", _hoisted_3, [
                    _cache[13] || (_cache[13] = createBaseVNode("label", { for: "#" }, "Aportacion Anual", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      "stack-label": "",
                  ...
                  createBaseVNode("div", _hoisted_4, [
                    _cache[14] || (_cache[14] = createBaseVNode("label", { for: "#" }, "Impacto mensual en cuota del beneficiario", -1)),
                    createVNode(QInput, {
                      outlined: "",
                  ...
                  createBaseVNode("div", _hoisted_5, [
                    _cache[15] || (_cache[15] = createBaseVNode("label", { for: "#" }, "¿Qué día del mes será su aportación?", -1)),
                    createVNode(QInput, {
                      outlined: "",
                      "stack-label": "",
                  ...
                  createBaseVNode("div", _hoisted_6, [
                    _cache[16] || (_cache[16] = createBaseVNode("label", { for: "#" }, "¿Requiere que pasen a recoger su donativo?", -1)),
                  ...
                  createBaseVNode("div", _hoisted_7, [
                    _cache[17] || (_cache[17] = createBaseVNode("label", { for: "#" }, "¿A cual domicilio?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QRadio, {
                  ...
                  createBaseVNode("div", _hoisted_8, [
                    _cache[18] || (_cache[18] = createBaseVNode("label", { for: "#" }, "¿Desea un recordatorio?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QCheckbox, {
                  ...
                  createBaseVNode("div", _hoisted_9, [
                    _cache[19] || (_cache[19] = createBaseVNode("label", { for: "#" }, "¿Desea un recibo deducible?", -1)),
                    createBaseVNode("div", null, [
                      createVNode(QCheckbox, {
                  ...
                  paymentConfig.value.wants_deductible_receipt ? (openBlock(), createElementBlock("div", _hoisted_10, [
                    _cache[20] || (_cache[20] = createBaseVNode("div", { class: "form-section-label q-mb-none" }, "Recibo deducible", -1)),
