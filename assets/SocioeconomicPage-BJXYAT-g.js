import { W as mergeModels, U as useModel, K as onMounted, r as ref, V as api, a as computed, w as watch, B as createElementBlock, s as openBlock, v as createVNode, N as createBaseVNode, t as withCtx, G as QBtn, z as createTextVNode, D as toDisplayString, A as unref, a1 as QCard, X as QCardSection, Y as QInput, ac as QCardActions, x as withDirectives, a3 as QDialog, af as Dialog, am as QRadio, aQ as vShow, q as createBlock, y as createCommentVNode, a2 as QCheckbox, F as Fragment, C as renderList } from "./index-CnS-WeK3.js";
import { Q as QSelect, b as QField } from "./QSelect-DXvU-ucL.js";
import { Q as QMarkupTable } from "./QMarkupTable-fiyMGfcs.js";
import { Q as QTd } from "./QTd-C6VbChFu.js";
import { Q as QTr } from "./QTr-D_iIET07.js";
...
const _hoisted_4$1 = { class: "q-gutter-y-md" };
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const onSave = async () => {
      try {
        ...
        if (error.response && error.response.status === 422) {
          ...
          notify.negative("Por favor verifica los campos obligatorios o con errores");
        } else {
    ...
    const onDelete = (row) => {
      Dialog.create({
        ...
        message: `¿Estás seguro de que deseas eliminar a ${row.name || "este miembro"} de la lista?`,
        cancel: {
          flat: true,
          label: "Cancelar",
          color: "grey"
        ...
        try {
          loading.value = true;
          await api.delete(`family_members/${row.id}`);
          const index = rows.value.findIndex((item) => item.id === row.id);
          if (index !== -1) {
            rows.value.splice(index, 1);
          }
          notify.positive("Miembro eliminado exitosamente");
        } catch (error) {
          console.error(error);
          notify.negative("No se pudo eliminar al miembro de la familia");
        } finally {
          loading.value = false;
        }
      });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
            ...
            createVNode(QTd, { class: "text-right" }, {
              default: withCtx(() => [
                ...
                createVNode(QBtn, {
                  ...
                  color: "negative",
                  icon: "sym_o_delete",
                  onClick: ($event) => onDelete(props2.row),
        ...
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => showDialog.value = $event),
          position: "right",
          "full-height": ""
        }, {
          default: withCtx(() => [
            createVNode(QCard, { style: { "min-width": "400px" } }, {
              default: withCtx(() => [
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_3$1, toDisplayString(formData.value.id ? "Editar Registro" : "Nuevo Registro"), 1)
                  ]),
                  _: 1
                }),
                      ...
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_4$1, [
                          ...
                          createVNode(QInput, {
                            ...
                            "error-message": getError("age")
                          }, null, 8, ["modelValue", "error", "error-message"]),
                          createVNode(QSelect, {
                            outlined: "",
                            options: relationshipOptions,
                            modelValue: formData.value.relationship,
                            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => formData.value.relationship = $event),
                            label: "Parentesco",
                            error: !!errors.value.relationship,
                            "error-message": getError("relationship")
                          }, null, 8, ["modelValue", "error", "error-message"]),
                          createVNode(QSelect, {
                            outlined: "",
                            options: maritalStatusOptions,
                            modelValue: formData.value.marital_status,
                            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => formData.value.marital_status = $event),
                            label: "Estado civil",
                            error: !!errors.value.marital_status,
                            "error-message": getError("marital_status")
                          }, null, 8, ["modelValue", "error", "error-message"]),
                          createVNode(QInput, {
                            outlined: "",
                            modelValue: formData.value.scolarship,
                            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => formData.value.scolarship = $event),
                            label: "Escolaridad",
                            error: !!errors.value.scolarship,
                            "error-message": getError("scolarship")
                          }, null, 8, ["modelValue", "error", "error-message"]),
                          createVNode(QInput, {
                            modelValue: formData.value.ocupation,
                            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => formData.value.ocupation = $event),
                            label: "Ocupación",
                            outlined: "",
                            error: !!errors.value.ocupation,
                            "error-message": getError("ocupation")
                          }, null, 8, ["modelValue", "error", "error-message"]),
                          createVNode(QInput, {
                            outlined: "",
                            modelValue: formData.value.monthly_income,
                            "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => formData.value.monthly_income = $event),
                            modelModifiers: { number: true },
                            type: "number",
                            label: "Ingresos",
                            prefix: "$",
                            error: !!errors.value.monthly_income,
                            "error-message": getError("monthly_income")
                          }, null, 8, ["modelValue", "error", "error-message"]),
                          createVNode(QInput, {
                            outlined: "",
                            modelValue: formData.value.monthly_contribution,
                            "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => formData.value.monthly_contribution = $event),
                            modelModifiers: { number: true },
                            type: "number",
                            label: "Aportación",
                            prefix: "$",
                            error: !!errors.value.monthly_contribution,
                            "error-message": getError("monthly_contribution")
                          }, null, 8, ["modelValue", "error", "error-message"])
                        ])
                      ]),
                      _: 1
...
const _hoisted_51 = { class: "col-12 col-md-3" };
const _hoisted_52 = { class: "col-12 col-md-6" };
const _hoisted_53 = { class: "col-12 col-md-6" };
const _hoisted_54 = { class: "col-12 col-md-6" };
const _hoisted_55 = { class: "col-12 col-md-6" };
const _hoisted_56 = { class: "col-12 col-md-3" };
const _hoisted_57 = { class: "col-12 col-md-9" };
const _hoisted_58 = { class: "col-12 q-mb-md" };
const _hoisted_59 = { class: "flex justify-end" };
const _sfc_main = {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(QCard, {
          ...
          default: withCtx(() => [
            _cache[87] || (_cache[87] = createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Datos del Candidato", -1)),
        ...
        createVNode(QCard, {
          ...
          default: withCtx(() => [
            _cache[89] || (_cache[89] = createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Datos Generales del Solicitante del Estudio Socio-Económico", -1)),
            createBaseVNode("div", _hoisted_17, [
              ...
              _cache[88] || (_cache[88] = createBaseVNode("div", { class: "col-12" }, [
        ...
        createVNode(QCard, {
          ...
          default: withCtx(() => [
            _cache[90] || (_cache[90] = createBaseVNode("div", { class: "text-h6 q-mb-md" }, "Datos de Vivienda", -1)),
        ...
        createVNode(QCard, {
          ...
          default: withCtx(() => [
            ...
            createBaseVNode("div", _hoisted_46, [
              createBaseVNode("div", _hoisted_47, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[69] || (_cache[69] = ($event) => form.value.household_members_count = $event),
                  modelModifiers: { number: true },
                  type: "number",
            ...
            createVNode(_sfc_main$1, {
              ...
              "onUpdate:modelValue": _cache[70] || (_cache[70] = ($event) => familyData.value = $event)
            ...
            createBaseVNode("div", _hoisted_48, [
                ...
                createVNode(QField, {
                  ...
                  control: withCtx(() => [
                    createVNode(QRadio, {
                      ...
                      "onUpdate:modelValue": _cache[71] || (_cache[71] = ($event) => form.value.receives_govt_support = $event),
                      val: 1,
                      label: "Sí"
                    }, null, 8, ["modelValue"]),
                    createVNode(QRadio, {
                      modelValue: form.value.receives_govt_support,
                      "onUpdate:modelValue": _cache[72] || (_cache[72] = ($event) => form.value.receives_govt_support = $event),
                      val: 0,
                      label: "No"
                    }, null, 8, ["modelValue"])
                  ]),
              ...
              createBaseVNode("div", _hoisted_50, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[73] || (_cache[73] = ($event) => form.value.govt_support_institution = $event),
              ...
              createBaseVNode("div", _hoisted_51, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[74] || (_cache[74] = ($event) => form.value.govt_support_amount = $event),
                  modelModifiers: { number: true },
                  type: "number",
                  prefix: "$",
                ...
                createVNode(QField, {
                  ...
                  control: withCtx(() => [
                    createVNode(QRadio, {
                      ...
                      "onUpdate:modelValue": _cache[75] || (_cache[75] = ($event) => form.value.receives_additional_income = $event),
                      val: 1,
                      label: "Sí"
                    }, null, 8, ["modelValue"]),
                    createVNode(QRadio, {
                      modelValue: form.value.receives_additional_income,
                      "onUpdate:modelValue": _cache[76] || (_cache[76] = ($event) => form.value.receives_additional_income = $event),
                      val: 0,
                      label: "No"
                    }, null, 8, ["modelValue"])
                  ]),
              ...
              createBaseVNode("div", _hoisted_53, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[77] || (_cache[77] = ($event) => form.value.additional_income_amount = $event),
                  modelModifiers: { number: true },
                  type: "number",
                  prefix: "$",
                ...
                createVNode(QField, {
                  ...
                  control: withCtx(() => [
                    createVNode(QRadio, {
                      ...
                      "onUpdate:modelValue": _cache[78] || (_cache[78] = ($event) => form.value.other_disabled_members = $event),
                      val: 1,
                      label: "Sí"
                    }, null, 8, ["modelValue"]),
                    createVNode(QRadio, {
                      modelValue: form.value.other_disabled_members,
                      "onUpdate:modelValue": _cache[79] || (_cache[79] = ($event) => form.value.other_disabled_members = $event),
                      val: 0,
                      label: "No"
                    }, null, 8, ["modelValue"])
                  ]),
              ...
              createBaseVNode("div", _hoisted_55, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[80] || (_cache[80] = ($event) => form.value.disabled_members_type = $event),
              ...
              createBaseVNode("div", _hoisted_56, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[81] || (_cache[81] = ($event) => form.value.disabled_members_count = $event),
                  label: "9. ¿Cuántas?",
                  "stack-label": "",
                  outlined: "",
                  "hide-bottom-space": "",
              ...
              createBaseVNode("div", _hoisted_57, [
                createVNode(QInput, {
                  ...
                  "onUpdate:modelValue": _cache[82] || (_cache[82] = ($event) => form.value.disabled_members_ages = $event),
        ...
        createBaseVNode("div", _hoisted_58, [
          createVNode(QInput, {
            ...
            "onUpdate:modelValue": _cache[86] || (_cache[86] = ($event) => form.value.observations = $event),
            type: "textarea",
            label: "¿Hay Observaciones Adicionales?",
            "stack-label": "",
            outlined: "",
            "hide-bottom-space": ""
          }, null, 8, ["modelValue"])
