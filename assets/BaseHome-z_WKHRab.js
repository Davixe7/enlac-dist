import { as as createDirective, at as cleanEvt, au as client, av as preventDraggable, S as noop, aw as addEvt, a0 as stopAndPrevent, ax as position, ay as leftClick, y as getCurrentInstance, az as useTimeout, r as ref, A as computed, D as watch, B as h, aA as Transition, ag as getNormalizedVNodes, C as hSlot, aB as KeepAlive, v as createComponent, x as useDarkProps, z as useDark, aC as isNumber, o as onMounted, $ as onBeforeUnmount, aD as hDir, h as QBtn, ad as hMergeSlot, l as api, f as resolveComponent, q as createBlock, a as openBlock, w as withCtx, d as createVNode, b as createBaseVNode, c as createElementBlock, H as Fragment, K as renderList, m as QCard, P as normalizeStyle, n as QCardSection, t as toDisplayString, u as useAuthStore, E as createCommentVNode, g as unref } from "./index-CIixvMyj.js";
          ...
          createBaseVNode("div", _hoisted_1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(categoryOptions.value, (option) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                areaPermissions.value[unref(auth).data.user.work_area_id].some((allowed) => allowed == option.id) ? (openBlock(), createElementBlock("div", _hoisted_2, [
                  createVNode(_component_router_link, {
                    to: option.path,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !employeeRoles.value.includes(user.value?.role?.name) ? (openBlock(), createBlock(_sfc_main$2, { key: 0 })) : (openBlock(), createBlock(_sfc_main$1, { key: 1 }));
    };
  }
};
export {
