const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-CEqtFXTA.js","assets/QImg-u9OOrRwI.js","assets/index-CZ0dY6Fq.js","assets/index-DdS7KfM3.css","assets/QExpansionItem-BZV1BKyG.js","assets/QItem-B_syubG1.js","assets/candidate-store-BF7llngL.js","assets/notify-wpUyCu9G.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, x as onMounted, w as watch, O as createElementBlock, H as openBlock, Z as createBaseVNode, G as createBlock, I as withCtx, L as createCommentVNode, N as unref, bZ as defineAsyncComponent, c1 as Suspense, J as createVNode, U as QBtn, P as Fragment, R as renderList, S as toDisplayString, b3 as normalizeClass, a4 as api, b_ as __vitePreload } from "./index-CZ0dY6Fq.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(
      () => __vitePreload(() => import("./BeneficiaryProfile-CEqtFXTA.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0)
    );
    const props = __props;
