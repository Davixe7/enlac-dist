...
import { r as ref, m as computed, o as onMounted, c as createElementBlock, d as createVNode, w as withCtx, a as openBlock, b as createBaseVNode, s as createCommentVNode, F as Fragment, B as renderList, t as toDisplayString, E as normalizeClass, Q as QBtn, g as createTextVNode } from "./index-D6w-cXuQ.js";
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(configs.value).reverse(), (config) => {
                return openBlock(), createElementBlock("tr", { key: config }, [
                  createBaseVNode("td", null, "Cuota de " + toDisplayString(config == "" ? "Padres" : "Padrinos"), 1),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(configs.value[config], (payment2) => {
                    return openBlock(), createElementBlock("td", {
                      ...
                      onClick: ($event) => setPayment(config)
                    }, [
              ...
              candidate.value.id ? (openBlock(), createElementBlock("tr", _hoisted_2, [
...
const PaymentConfigControl = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-180d7c96"]]);
export {
