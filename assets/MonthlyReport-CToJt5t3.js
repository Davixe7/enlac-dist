const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-CgqcCI-S.js","assets/QImg-B_-JbdjU.js","assets/index-CZCe8xRO.js","assets/index-DA00BWT3.css","assets/QExpansionItem-g5Y3gt1Y.js","assets/QItem-C0btFpr9.js","assets/candidate-store-CQRYIpyx.js","assets/notify-BqysXg7-.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, o as onMounted, D as watch, c as createElementBlock, a as openBlock, b as createBaseVNode, q as createBlock, w as withCtx, E as createCommentVNode, g as unref, bY as defineAsyncComponent, b_ as Suspense, d as createVNode, h as QBtn, H as Fragment, K as renderList, t as toDisplayString, O as normalizeClass, l as api, bZ as __vitePreload } from "./index-CZCe8xRO.js";
...
const _sfc_main = {
  ...
  props: ["candidateId"],
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(() => __vitePreload(() => import("./BeneficiaryProfile-CgqcCI-S.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0));
    const props = __props;
