...
import { o as onMounted, m as computed, r as ref, j as createBlock, a as openBlock, w as withCtx, d as createVNode, b as createBaseVNode, h as QIcon, t as toDisplayString, Q as QBtn, g as createTextVNode, c as createElementBlock, F as Fragment, B as renderList, f as resolveComponent } from "./index-BKlFzi9U.js";
...
import { a as QItem, Q as QItemSection, b as QItemLabel } from "./QItemLabel-TX7ESzio.js";
...
const _hoisted_2$1 = { class: "text-right" };
const _hoisted_3$1 = { colspan: "2" };
const _hoisted_4$1 = { class: "flex justify-end" };
const _sfc_main$1 = {
            ...
            createBaseVNode("tbody", null, [
              _cache[6] || (_cache[6] = createBaseVNode("tr", null, [
                createBaseVNode("td", { colspan: "2" }, [
                  createBaseVNode("div", { class: "page-subtitle q-my-none" }, "Padrinos")
                ])
              ], -1)),
              (openBlock(true), createElementBlock(Fragment, null, renderList(paymentConfigs.value, (paymentConfig) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("div", _hoisted_1$1, toDisplayString(paymentConfig.sponsor.name), 1),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          createVNode(QMarkupTable, { bordered: "" }, {
            default: withCtx(() => [
              createBaseVNode("tbody", null, [
                _cache[6] || (_cache[6] = createBaseVNode("tr", null, [
                  createBaseVNode("td", { colspan: "2" }, [
                    createBaseVNode("div", { class: "page-subtitle q-my-none" }, "Cuotas mensuales")
                  ])
                ], -1)),
                createBaseVNode("tr", null, [
                  _cache[1] || (_cache[1] = createBaseVNode("td", null, "Cuota de Padres:", -1)),
                  createBaseVNode("td", null, [
                    createVNode(QInput, {
                      outlined: "",
                ...
                createBaseVNode("tr", null, [
                  _cache[2] || (_cache[2] = createBaseVNode("td", null, "Cuota de Padrinos:", -1)),
                  createBaseVNode("td", null, "$" + toDisplayString(amountSponsors.value), 1)
                ]),
                createBaseVNode("tr", null, [
                  _cache[3] || (_cache[3] = createBaseVNode("td", null, "Cuota de ENLAC:", -1)),
                  createBaseVNode("td", null, "$" + toDisplayString(amountEnlac.value), 1)
                ]),
                createBaseVNode("tr", null, [
                  _cache[4] || (_cache[4] = createBaseVNode("td", null, "Total del Programa:", -1)),
