import { g as getCurrentInstance, i as inject, e as emptyRenderFn, l as layoutKey, a as computed, b as hSlot, h, c as createComponent, r as ref, O as createElementBlock, H as openBlock, J as createVNode, I as withCtx, U as QBtn, a9 as QInput, G as createBlock, aR as normalizeProps, aS as guardReactiveProps, b3 as normalizeClass, M as createTextVNode, S as toDisplayString, Z as createBaseVNode, a5 as QCard, L as createCommentVNode, a6 as QCardSection, ac as QCardActions, K as withDirectives, aa as QDialog, P as Fragment, w as watch, x as onMounted, ah as QRadio, a4 as api, Q as QIcon, R as renderList, ad as withModifiers, ae as QCheckbox } from "./index-CZ0dY6Fq.js";
import { Q as QItem, a as QItemSection, b as QItemLabel } from "./QItem-B_syubG1.js";
...
import { _ as _sfc_main$2 } from "./EnlacDate-BCFtwSKY.js";
import { u as useCategoryStore } from "./category-store-MWzNgRyZ.js";
import { _ as _sfc_main$3 } from "./IssuesForm-DGxPNOI7.js";
              ...
              default: withCtx(() => [
                createVNode(QCardSection, { class: "flex items-center" }, {
                  default: withCtx(() => [
                    ...
                    _cache[12] || (_cache[12] = createBaseVNode("h1", { class: "page-subtitle q-my-none" }, "Registrar Incidencia", -1)),
                    createVNode(QBtn, {
        ...
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            ...
            optionId.value ? (openBlock(), createBlock(_sfc_main$1, {
              key: 0,
              rows: scores.value,
              "onUpdate:rows": _cache[8] || (_cache[8] = ($event) => scores.value = $event),
                ...
                default: withCtx(() => [
                  createVNode(QCardSection, { class: "bg-positive" }, {
                    default: withCtx(() => [
                      ...
                      _cache[13] || (_cache[13] = createBaseVNode("span", { class: "text-green-1" }, "Dia cerrado, no se admiten actualizaciones.", -1))
                    ]),
                    _: 1
                  })
                ]),
            ...
            emptySearch.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
              ...
              _cache[14] || (_cache[14] = createTextVNode(" No hay resultados coincidentes con la busqueda "))
            ])) : createCommentVNode("", true),
            !optionId.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
              ...
              _cache[15] || (_cache[15] = createBaseVNode("h6", { class: "q-my-sm" }, "Selecciona un beneficiario o actividad", -1)),
              _cache[16] || (_cache[16] = createBaseVNode("p", null, "para empezar a evaluar", -1))
            ])) : createCommentVNode("", true)
          ])
        ]),
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_12, [
                  ...
                  createBaseVNode("div", null, [
                    _cache[17] || (_cache[17] = createTextVNode(" Estás visualizando una fecha pasada, no se admiten modificaciones. ")),
                    createVNode(QBtn, {
                      unelevated: "",
                      dense: "",
                      label: "Ir a hoy",
                      onClick: _cache[11] || (_cache[11] = ($event) => dateISO.value = (/* @__PURE__ */ new Date()).toISOString().split("T")[0]),
