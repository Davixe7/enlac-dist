...
import { Q as QImg } from "./QImg-yiivFUzd.js";
          ...
          createBaseVNode("div", _hoisted_1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(options.value, (option) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                user.value?.role?.name == option.role ? (openBlock(), createElementBlock("div", _hoisted_2, [
                  createVNode(_component_router_link, {
                    to: option.path,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !unref(store).can("rides.index") ? (openBlock(), createBlock(_sfc_main$2, { key: 0 })) : (openBlock(), createBlock(_sfc_main$1, { key: 1 }));
    };
  }
};
export {
