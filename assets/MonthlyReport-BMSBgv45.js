const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-BxHDMqq6.js","assets/QImg-ByYKIFE6.js","assets/index-73seMa9c.js","assets/index-DdS7KfM3.css","assets/QExpansionItem-BGfvCx58.js","assets/QItem-BL3QQOOm.js","assets/candidate-store-Dr0LGjAO.js","assets/notify-CI1eDtFr.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, x as onMounted, w as watch, O as createElementBlock, H as openBlock, Z as createBaseVNode, G as createBlock, I as withCtx, L as createCommentVNode, N as unref, bZ as defineAsyncComponent, c1 as Suspense, J as createVNode, U as QBtn, P as Fragment, R as renderList, S as toDisplayString, b3 as normalizeClass, a4 as api, b_ as __vitePreload } from "./index-73seMa9c.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(
      () => __vitePreload(() => import("./BeneficiaryProfile-BxHDMqq6.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0)
    );
    const props = __props;
