const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BeneficiaryProfile-DkZZXNs-.js","assets/QImg-Dg3-E4FR.js","assets/index-Lpbv6tCz.js","assets/index-DdS7KfM3.css","assets/QExpansionItem-B0eFPBRc.js","assets/QItem-hGGqEP0j.js","assets/candidate-store-DCmh2JEQ.js","assets/notify-DG_2rm3w.js","assets/BeneficiaryProfile-BcAD6YyA.css"])))=>i.map(i=>d[i]);
import { r as ref, x as onMounted, w as watch, O as createElementBlock, H as openBlock, Z as createBaseVNode, G as createBlock, I as withCtx, L as createCommentVNode, N as unref, b_ as defineAsyncComponent, c2 as Suspense, J as createVNode, U as QBtn, P as Fragment, R as renderList, S as toDisplayString, ab as normalizeClass, a4 as api, b$ as __vitePreload } from "./index-Lpbv6tCz.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    const BeneficiaryProfile = defineAsyncComponent(
      () => __vitePreload(() => import("./BeneficiaryProfile-DkZZXNs-.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7,8]) : void 0)
    );
    const props = __props;
