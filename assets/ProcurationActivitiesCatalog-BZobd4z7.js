import { r as ref, K as onMounted, q as createBlock, s as openBlock, t as withCtx, N as createBaseVNode, B as createElementBlock, y as createCommentVNode, v as createVNode, Y as QInput, G as QBtn, V as api, a3 as QDialog, F as Fragment, a1 as QCard, X as QCardSection, x as withDirectives, D as toDisplayString, Z as withModifiers, a2 as QCheckbox } from "./index-CnS-WeK3.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    async function fetchRaffle() {
      ...
      try {
        ...
        if (response && response.id) {
          ...
          initialTicketsCount.value = response.tickets_count || 0;
        }
      } catch (error) {
        console.log(error);
    ...
    function calculateTotalTickets(val) {
      const toAdd = Number(val) || 0;
      if (configForm.value.id) {
        configForm.value.tickets_count = initialTicketsCount.value + toAdd;
      } else {
        configForm.value.tickets_count = toAdd;
      }
    }
    async function saveRaffle() {
      ...
      try {
        ...
        const payload = {
          ...configForm.value,
          procuration_activity_id: props.procurationActivityId,
          tickets_to_add: ticketsToAdd.value || 0
        };
        let response = (await api.post("raffles", payload)).data.data;
        if (response && response.id) {
          configForm.value = { ...response };
          initialTicketsCount.value = response.tickets_count || 0;
          ticketsToAdd.value = null;
          notify.positive("Información actualizada correctamente");
        }
      } catch (error) {
        console.log(error);
      ...
      return openBlock(), createBlock(QMarkupTable, null, {
        default: withCtx(() => [
          createBaseVNode("tr", null, [
            _cache[10] || (_cache[10] = createBaseVNode("td", null, "Número de Boletos", -1)),
          ...
          createBaseVNode("tr", null, [
            _cache[11] || (_cache[11] = createBaseVNode("td", null, "Precio del Boleto", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          createBaseVNode("tr", null, [
            _cache[12] || (_cache[12] = createBaseVNode("td", null, "Fecha de Creación", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          createBaseVNode("tr", null, [
            _cache[13] || (_cache[13] = createBaseVNode("td", null, "Fecha del Evento", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          createBaseVNode("tr", null, [
            _cache[14] || (_cache[14] = createBaseVNode("td", null, "Lugar", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          createBaseVNode("tr", null, [
            _cache[15] || (_cache[15] = createBaseVNode("td", null, "Boleto Ganador", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          createBaseVNode("tr", null, [
            _cache[16] || (_cache[16] = createBaseVNode("td", null, "Nombre del Ganador", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          createBaseVNode("tr", null, [
            _cache[17] || (_cache[17] = createBaseVNode("td", null, "Nombre del Vendedor Ganador", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
          ...
          configForm.value.id ? (openBlock(), createElementBlock("tr", _hoisted_1$1, [
            _cache[18] || (_cache[18] = createBaseVNode("td", null, "Sumar Boletos", -1)),
            createBaseVNode("td", null, [
              createVNode(QInput, {
                outlined: "",
                dense: "",
                type: "number",
                min: "0",
                modelValue: ticketsToAdd.value,
                "onUpdate:modelValue": [
                  _cache[8] || (_cache[8] = ($event) => ticketsToAdd.value = $event),
          ...
          createBaseVNode("tr", null, [
            ...
            createBaseVNode("td", _hoisted_2$1, [
              createVNode(QBtn, {
                ...
                onClick: _cache[9] || (_cache[9] = ($event) => saveRaffle())
              }, null, 8, ["loading"])
            ])
          ])
        ]),
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const activityTypes = ref(PROCURATION_ACTIVITY_TYPES);
    ...
    onMounted(async () => {
      try {
        const [actRes, typesRes] = await Promise.all([
          api.get("/procuration-activities"),
          api.get("/procuration-activities/types")
        ]);
        let data = actRes.data.data || actRes.data;
        rows.value = data.sort((a, b) => a.name.localeCompare(b.name));
        if (typesRes.data && Array.isArray(typesRes.data)) {
          activityTypes.value = typesRes.data.map((item) => item.label);
        }
      } catch (error) {
            ...
            createVNode(QTd, { class: "text-right q-gutter-x-sm" }, {
              default: withCtx(() => [
                ["Obsequio entre Amigos", "Radiomaratón"].includes(props.row.type) ? (openBlock(), createBlock(QBtn, {
                  ...
                  dense: "",
                  color: "secondary",
                  to: props.row.type === "Radiomaratón" ? { name: "radiomaraton.operar", params: { radiomarathonId: props.row.id } } : { name: "raffles", query: { procuration_activity_id: props.row.id } }
